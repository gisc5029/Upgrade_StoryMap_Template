/*! Storymaps-MapSeries - v1.10.1 - 2017-12-19, 05:21:55 PM - This application is released under the Apache License V2.0 by Esri http://www.esri.com/ - https://github.com/Esri/map-series-storytelling-template-js */ define("lib-build/css", [], function () {
    ...
    !(function (e, t) {
            ...
            if (p.acceptData(e)) {
                ...
                if ((l && f[l] && (i || f[l].data)) || void 0 !== r || "string" != typeof t)
                    return (
                        ...
                        ("object" == typeof t || "function" == typeof t) && (i ? (f[l] = p.extend(f[l], t)) : (f[l].data = p.extend(f[l].data, t))),
                        (o = f[l]),
                        i || (o.data || (o.data = {}), (o = o.data)),
                        void 0 !== r && (o[p.camelCase(t)] = r),
                        "string" == typeof t ? ((s = o[t]), null == s && (s = o[p.camelCase(t)])) : (s = o),
                        s
                    );
            }
        }
        ...
        function Lt(e, t) {
            ...
            if (1 === t.nodeType) {
                ...
                "script" === n && t.text !== e.text
                    ...
                    : "object" === n
                        ? (t.parentNode && (t.outerHTML = e.outerHTML), c.html5Clone && e.innerHTML && !p.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
        ...
        function _t(e) {
            ...
            return (
                ...
                ((n = Mt(e, t)),
                    ("none" !== n && n) ||
                    ((At = (At || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = (At[0].contentWindow || At[0].contentDocument).document), t.write(), t.close(), (n = Mt(e, t)), At.detach()),
                    (Ot[e] = n)),
                n
            );
        }
            ...
            for (var n, r, i, s = [], o = 0, u = e.length; u > o; o++)
                (r = e[o]),
                    ...
                    ((s[o] = p._data(r, "olddisplay")),
                        (n = r.style.display),
                        t
                            ? (s[o] || "none" !== n || (r.style.display = ""), "" === r.style.display && $(r) && (s[o] = p._data(r, "olddisplay", _t(r.nodeName))))
                            : s[o] || ((i = $(r)), ((n && "none" !== n) || !i) && p._data(r, "olddisplay", i ? n : p.css(r, "display"))));
        ...
        function Qt(e, t, n, r, i) {
            for (var s = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2)
                "margin" === n && (o += p.css(e, n + V[s], !0, i)),
                    r
                        ? ("content" === n && (o -= p.css(e, "padding" + V[s], !0, i)), "margin" !== n && (o -= p.css(e, "border" + V[s] + "Width", !0, i)))
                        : ((o += p.css(e, "padding" + V[s], !0, i)), "padding" !== n && (o += p.css(e, "border" + V[s] + "Width", !0, i)));
            return o;
        }
        function Gt(e, t, n) {
            var r = !0,
        ...
        function ln(e, t, n) {
            ...
            n.queue ||
                ...
                ((n.overflow = [v.overflow, v.overflowX, v.overflowY]),
                    ...
                    (l = _t(e.nodeName)),
                    "none" === f && (f = l),
                    "inline" === f && "none" === p.css(e, "float") && (c.inlineBlockNeedsLayout && "inline" !== l ? (v.zoom = 1) : (v.display = "inline-block"))),
                n.overflow &&
                ((v.overflow = "hidden"),
                    c.shrinkWrapBlocks() ||
                    h.always(function () {
                        ...
                        for (r in i)
                            (e = o[r]),
                                ...
                                (f && n && (p.isPlainObject(n) || (t = p.isArray(n)))
                                    ? (t ? ((t = !1), (s = e && p.isArray(e) ? e : [])) : (s = e && p.isPlainObject(e) ? e : {}), (o[r] = p.extend(f, s, n)))
                                    : void 0 !== n && (o[r] = n));
                return o;
            }),
            p.extend({
        ...
        var b = (function (e) {
            ...
            function dt(e, t) {
                ...
                (u = e), (a = []), (f = r.preFilter);
                while (u) {
                    (!n || (i = U.exec(u))) && (i && (u = u.slice(i[0].length) || u), a.push((s = []))), (n = !1), (i = z.exec(u)) && ((n = i.shift()), s.push({ value: n, type: i[0].replace(R, " ") }), (u = u.slice(n.length)));
                ...
                (r = rt.selectors = {
                    ...
                    preFilter: {
                        ...
                        CHILD: function (e) {
                            return (
                                (e[1] = e[1].toLowerCase()),
                                "nth" === e[1].slice(0, 3) ? (e[3] || rt.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3]))), (e[5] = +(e[7] + e[8] || "odd" === e[3]))) : e[3] && rt.error(e[0]),
                                e
                            );
                        },
                        PSEUDO: function (e) {
                            ...
                            return $.CHILD.test(e[0])
                                ? null
                                : (e[3] && void 0 !== e[4] ? (e[2] = e[4]) : n && X.test(n) && (t = dt(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                        },
                    },
                    filter: {
                        TAG: function (e) {
            ...
            p(function () {
                ...
                n &&
                    ((e = N.createElement("div")),
                        ...
                        typeof t.style.zoom !== j && ((t.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1"), (c.inlineBlockNeedsLayout = 3 === t.offsetWidth) && (n.style.zoom = 1)),
                        n.removeChild(e),
                        (e = t = null));
            }),
            (function () {
        ...
        !(function () {
            ...
            if (
                (t.setAttribute("className", "t"),
                    ...
                    (c.html5Clone = "<:nav></:nav>" !== N.createElement("nav").cloneNode(!0).outerHTML),
                    (n.type = "checkbox"),
                    (n.checked = !0),
                    e.appendChild(n),
                    ...
                    while (u--)
                        (s = et.exec(t[u]) || []),
                            ...
                            ((f = p.event.special[d] || {}),
                                ...
                                (f = p.event.special[d] || {}),
                                (c = p.extend({ type: d, origType: m, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && p.expr.match.needsContext.test(i), namespace: v.join(".") }, a)),
                                (h = o[d]) || ((h = o[d] = []), (h.delegateCount = 0), (f.setup && f.setup.call(e, r, v, l) !== !1) || (e.addEventListener ? e.addEventListener(d, l, !1) : e.attachEvent && e.attachEvent("on" + d, l))),
                        ...
                        if (((u = et.exec(t[f]) || []), (d = m = u[1]), (v = (u[2] || "").split(".").sort()), d)) {
                            ...
                            while (s--)
                                (o = h[s]),
                                    ...
                                    (h.splice(s, 1), o.selector && h.delegateCount--, c.remove && c.remove.call(e, o));
                    ...
                    while ((s = u[t++]) && !e.isPropagationStopped()) {
                        ...
                        while ((i = s.handlers[o++]) && !e.isImmediatePropagationStopped())
                            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
                                ((e.handleObj = i), (e.data = i.data), (n = ((p.event.special[i.origType] || {}).handle || i.handler).apply(s.elem, a)), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()));
                    }
                ...
                return this instanceof p.Event
                    ? (e && e.type
                        ? ((this.originalEvent = e),
                            (this.type = e.type),
                            (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && (e.returnValue === !1 || (e.getPreventDefault && e.getPreventDefault()))) ? tt : nt))
                        : (this.type = e),
                        t && p.extend(this, t),
        ...
        (yt.optgroup = yt.option),
            ...
            p.extend({
                clone: function (e, t, n) {
                    ...
                    if (t)
                        if (n) for (u = u || Et(e), r = r || Et(s), o = 0; null != (i = u[o]); o++) kt(i, r[o]);
                        else kt(e, s);
                ...
                (Bt = function (e, t, n) {
                    ...
                    return (
                        ...
                        ("" !== o || p.contains(e.ownerDocument, e) || (o = p.style(e, t)),
                            Pt.test(o) && Dt.test(t) && ((r = u.width), (i = u.minWidth), (s = u.maxWidth), (u.minWidth = u.maxWidth = u.width = o), (o = n.width), (u.width = r), (u.minWidth = i), (u.maxWidth = s))),
                        void 0 === o ? o : o + ""
                    );
                }))
            ...
            ((Ht = function (e) {
                ...
                (Bt = function (e, t, n) {
                    ...
                    return (
                        ...
                        Pt.test(o) &&
                        !jt.test(t) &&
                        ((r = u.left), (i = e.runtimeStyle), (s = i && i.left), s && (i.left = e.currentStyle.left), (u.left = "fontSize" === t ? "1em" : o), (o = u.pixelLeft + "px"), (u.left = r), s && (i.left = s)),
                        void 0 === o ? o : o + "" || "auto"
                    );
                })),
            !(function () {
                function l() {
                    ...
                    u &&
                        ((t = N.createElement("div")),
                            ...
                            (s = !1),
                            (o = !0),
                            e.getComputedStyle && ((s = "1%" !== (e.getComputedStyle(n, null) || {}).top), (i = "4px" === (e.getComputedStyle(n, null) || { width: "4px" }).width)),
                            u.removeChild(t),
                            (n = u = null));
                }
                var t,
        ...
        p.extend({
            ...
            style: function (e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    if (
                        ((s = typeof n),
                            "string" === s && (i = zt.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(p.css(e, t))), (s = "number")),
                            null != n && n === n && ("number" !== s || p.cssNumber[u] || (n += "px"), c.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (a[t] = "inherit"), !(o && "set" in o && void 0 === (n = o.set(e, n, r)))))
                    )
                        try {
                            (a[t] = ""), (a[t] = n);
                        } catch (f) { }
            ...
            (p.cssHooks.marginRight = Ft(c.reliableMarginRight, function (e, t) {
                return t ? p.swap(e, { display: "inline-block" }, Bt, [e, "marginRight"]) : void 0;
            })),
        ...
        (p.Animation = p.extend(hn, {
            ...
            (p.speed = function (e, t, n) {
                var r = e && "object" == typeof e ? p.extend({}, e) : { complete: n || (!n && t) || (p.isFunction(e) && e), duration: e, easing: (n && t) || (t && !p.isFunction(t) && t) };
                return (
                    (r.duration = p.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in p.fx.speeds ? p.fx.speeds[r.duration] : p.fx.speeds._default),
                ...
                attr: function (e, t, n) {
                    ...
                    if (e && 3 !== s && 8 !== s && 2 !== s)
                        return typeof e.getAttribute === j
                            ? p.prop(e, t, n)
                            : ((1 === s && p.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = p.attrHooks[t] || (p.expr.match.bool.test(t) ? vn : dn))),
                                void 0 === n
        ...
        (Cn = Pn.exec(kn.toLowerCase()) || []),
            p.extend({
                ...
                ajaxSettings: {
                    ...
                    accepts: { "*": jn, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
                    ...
                    function x(e, t, n, r) {
                        ...
                        2 !== b &&
                            ((b = 2),
                                ...
                                (w = zn(l, w, E, f)),
                                f
                                    ? (l.ifModified && ((S = E.getResponseHeader("Last-Modified")), S && (p.lastModified[i] = S), (S = E.getResponseHeader("etag")), S && (p.etag[i] = S)),
                                        204 === e || "HEAD" === l.type ? (x = "nocontent") : 304 === e ? (x = "notmodified") : ((x = w.state), (g = w.data), (y = w.error), (f = !y)))
                    ...
                    if (
                        ((d.promise(E).complete = v.add),
                            ...
                            (l.dataTypes = p
                                ...
                                .match(M) || [""]),
                            null == l.crossDomain &&
                            ((n = Pn.exec(l.url.toLowerCase())), (l.crossDomain = !(!n || (n[1] === Cn[1] && n[2] === Cn[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Cn[3] || ("http:" === Cn[1] ? "80" : "443")))))),
            ...
            p.each(["get", "post"], function (e, t) {
                p[t] = function (e, n, r, i) {
                    return p.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), p.ajax({ url: e, type: t, dataType: i, data: n, success: r });
                };
            }),
        ...
        (p.fn.load = function (e, t, n) {
            ...
            return (
                ...
                p.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (s = "POST"),
                o.length > 0 &&
                p
                ...
                offset: function (e) {
                    ...
                    if (s)
                        return (
                            (t = s.documentElement),
                            p.contains(t, i)
                                ? (typeof i.getBoundingClientRect !== j && (r = i.getBoundingClientRect()),
                                    (n = sr(s)),
                    ...
                    if (this[0]) {
                        ...
                        return (
                            "fixed" === p.css(r, "position")
                                ...
                                : ((e = this.offsetParent()), (t = this.offset()), p.nodeName(e[0], "html") || (n = e.offset()), (n.top += p.css(e[0], "borderTopWidth", !0)), (n.left += p.css(e[0], "borderLeftWidth", !0))),
                            { top: t.top - n.top - p.css(r, "marginTop", !0), left: t.left - n.left - p.css(r, "marginLeft", !0) }
                        );
                    }
                },
    ...
    define("storymaps/common/utils/SocialSharing", ["dojo/Deferred", "esri/urlUtils"], function (e, t) {
        return {
            ...
            shareTwitter: function (e, t) {
                var n = "text=" + encodeURIComponent(e || "") + "&url=" + this.cleanURL(t || document.location.href) + "&related=EsriStoryMaps" + "&hashtags=StoryMaps";
                window.open("https://twitter.com/intent/tweet?" + n, "", "toolbar=0,status=0,width=626,height=436");
            },
            requestShortUrl: function (t) {
                var n = "https://arcg.is/prod/shorten?callback=?",
                    r = t || document.location.href,
                    i = new e();
                return (
                    $.getJSON(n, { longUrl: r }, function (e) {
                        console.log(e), !e || !e || !e.data.url ? i.reject() : i.resolve(e.data.url);
                    }),
                    i
                );
            },
            cleanURL: function (e, n) {
                ...
                return (
                    r.query &&
                    (delete r.query.edit,
                        delete r.query.locale,
                        delete r.query.folderId,
                        delete r.query.webmap,
                        delete r.query.autoplay,
                        $.each(Object.keys(r.query), function (e, t) {
        ...
        return {
            ...
            switchToBuilder: function () {
                document.location.search.match(/appid/)
                    ? (document.location = o.cleanURL(document.location.protocol + "//" + document.location.host + document.location.pathname + document.location.search, !0) + "&edit" + document.location.hash)
                    : document.location.search.slice(-1) == "?"
                        ? (document.location = o.cleanURL(document.location.protocol + "//" + document.location.host + document.location.pathname, !0) + "?edit" + document.location.hash)
                        : (document.location = o.cleanURL(document.location.protocol + "//" + document.location.host + document.location.pathname, !0) + "?edit" + document.location.hash);
            },
            ...
            getUrlParams: function () {
                var e = c.urlToObject(document.location.search).query;
                return e ? e : !this.browserSupportHistory() && !e ? c.urlToObject(document.location.hash).query || {} : {};
            },
            ...
            getWebMapExtentFromItem: function (e) {
                ...
                var t = p.geographicToWebMercator(new d(e.extent[0][0], e.extent[0][1])),
                    n = p.geographicToWebMercator(new d(e.extent[1][0], e.extent[1][1]));
                return new v({ xmax: n.x, xmin: t.x, ymax: n.y, ymin: t.y, spatialReference: { wkid: 102100 } });
            },
            serializeExtentToItem: function (e) {
                if (!e || !e.spatialReference) return null;
                var t = e.spatialReference.wkid == 4326 ? e : p.webMercatorToGeographic(e);
                return [
            ...
            cloneLayer: function (e) {
                return e.url && e.url.match(/virtualearth\./)
                    ? new b("http://services.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer")
                    : e instanceof b
                        ? new b(e.url)
                        : e instanceof y
                            ? new y(e.url)
            ...
            extentToPolygon: function (e) {
                var t = new m(e.spatialReference);
                return (
                    t.addRing([
                        [e.xmin, e.ymin],
                        [e.xmin, e.ymax],
            ...
            getPortalURL: function () {
                return h.arcgisUrl.split("/sharing/")[0];
            },
            ...
            createGeocoder: function (e) {
                ...
                var a = u.processAppDataGeocoders(e.placeHolder);
                r.length && (o = r);
                ...
                var c = { map: e.map, allPlaceholder: e.placeHolder, enableButtonMode: e.enableButtonMode };
                o && o.length ? (this.checkForSourceNameDuplicates(o), (c.sources = o)) : (c.placeholder = e.placeHolder || S.commonMedia.editorActionGeocode.lblTitle);
                var h = new f(c, e.domNode);
                if (n.length) {
                    var p = new s(n);
                    p.then(function (n) {
            ...
            getGeocoderRequest: function (e) {
                ...
                return !app.isInBuilder && !app.portal.user ? (t.disableIdentityLookup = !0) : (t.callbackParamName = "callback"), a(t);
            },
            getLayerSources: function (e, t, n) {
                var r = this;
                return $.map(e, function (e) {
                    var i = t.getLayer(e.id),
                        s = { featureLayer: i, searchFields: [e.field.name], displayField: e.field.name, exactMatch: e.field.exactMatch, outFields: ["*"], maxResults: 6, name: r.findGeocoderName(i, e), placeholder: n };
                    if (e.subLayer || e.subLayer === 0) {
                        var o = e.subLayer,
                            u;
                        (u = i.dynamicLayerInfos) && (u = u[e.subLayer]) && (u = u.source) && (o = u.mapLayerId), (s.featureLayer = new g(i.url + "/" + e.subLayer));
                    }
                    return s;
                });
            },
            processGeocoderRequestReturn: function (e, t) {
                ...
                return (
                    $.each(e, function (e, i) {
                        if (!i[0] || !i[1] || !i[1].singleLineAddressField) return;
                        var s = app.cfg.HELPER_SERVICES.geocode[e],
                            o = new l(s.url),
                            u = { singleLineFieldName: i[1].singleLineAddressField.name, name: s.name ? s.name : i[1].name, placeholder: s.placeholder || t || S.commonMedia.editorActionGeocode.lblTitle, locator: o };
                        (u.name = u.name || r.findGeocoderName({ url: o.url })), r.isEsriGeocoder({ url: s.url }) && (u.placeholder = S.commonMedia.editorActionGeocode.lblTitle);
                        if (!i[1].capabilities || i[1].capabilities.toLowerCase().indexOf("suggest") < 0) u.enableSuggestions = !1;
                        n.push(u);
                    }),
                    n
                );
            ...
            processAppDataGeocoders: function (e) {
                ...
                t || (t = [{ name: "Esri World Geocoder", url: "//geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer", singleLineFieldName: "SingleLine" }]);
                if (!t.length) return [];
                t = t.slice();
                var r = [],
                    i = this;
                return (
                    $.each(t, function (t, s) {
                        if (s.url) {
                            var o = n.mixin({}, s);
                            (o.locator = new l(o.url)),
                                i.isEsriGeocoder({ url: o.url })
                                    ? ((o.placeholder = S.commonMedia.editorActionGeocode.lblTitle), (o.name = E.commonWebmap.selector.lblEsriGeocoder))
                                    : ((o.placeholder = o.placeholder || e), (o.name = o.name || i.findGeocoderName({ url: o.url }))),
                                r.push(o);
                        }
                    }),
                    r
            ...
            setGeocodeSources: function (e, t) {
                this.checkForSourceNameDuplicates(t), e.set("sources", t), e.set("activeSourceIndex", 0), e.startup();
                if (!app.data.getWebAppData().getAppGeocoders) return;
                !app.data.getWebAppData().getAppGeocoders() && e._allIndex && e.set("activeSourceIndex", e._allIndex);
            },
            checkForSourceNameDuplicates: function (e) {
                var t = [],
                    n = this;
                $.each(e, function (e, r) {
                    t.indexOf(r.name) >= 0 && (r.name = n.getAdjustedSourceName(t, r.name)), t.push(r.name);
                });
            },
            getAdjustedSourceName: function (e, t) {
                var n = 2,
                    r = t + " - " + n;
                while (e.indexOf(r) >= 0) n++, (r = t + " - " + n);
                return r;
            },
            ...
            findGeocoderName: function (e, t) {
                ...
                if (!n) {
                    if (!this.isEsriGeocoder(e)) {
                        if (typeof e.url != "string" || !e.url.split) return;
                        var i = e.url.split("/"),
                            s = i[i.length - 2];
                        s && (n = s);
                        return;
                    }
                    n = E.commonWebmap.selector.lblEsriGeocoder;
                }
            ...
            convertToDegrees: function (e) {
                var t = e[0].numerator,
                    ...
                    u = e[2].numerator,
                    a = e[2].denominator,
                    f = parseFloat(u) / parseFloat(a);
                return r + o / 60 + f / 3600;
            },
                ...
                return (
                    (function (e, t) {
                        if (e.constructor == Array)
                            if (!t || t.constructor != Array || t.length != e.length) n.push({ Property: r.join(""), ObjectA: e, ObjectB: t });
                            else for (var i = 0; i < e.length; i++) r.push("[" + i.toString() + "]"), arguments.callee(e[i], t[i]), r.pop();
                            ...
                            for (var s in e) r.push("." + s), t[s] ? e[s] && e[s].constructor != Function && arguments.callee(e[s], t[s]) : n.push({ Property: r.join(""), ObjectA: e[s], ObjectB: null }), r.pop();
                        else e.constructor != Function && e != t && n.push({ Property: r.join(""), ObjectA: e, ObjectB: t });
                    })(e, t),
                    n
                );
            },
            possiblyAddToken: function (e) {
                ...
                if (!this.needsTokenAdded(e)) return e;
                var t = "";
                return (
                    app.portal && app.portal.getPortalUser()
                        ? (t = app.portal.getPortalUser().credential.token)
                        : u.findCredential(document.location.origin)
                            ? (t = u.findCredential(document.location.origin).token)
                            : u.findCredential(app.portal.url)
                                ? (t = u.findCredential(app.portal.url).token)
                                : (t = this.getCookieToken()),
    ...
    define("storymaps/common/builder/PortalVersionTest", ["esri/arcgis/utils", "dojo/Deferred"], function (e, t) {
        ...
        return {
            run: function () {
                ...
                return (
                    (i.src = s + "MyStories/assets/my-stories-portal-detector.png"),
                    (i.onload = function () {
    ...
    define("storymaps/common/builder/MyStoriesWrapper", ["./PortalVersionTest", "esri/IdentityManager", "storymaps/common/utils/CommonHelper", "dojo/topic"], function (e, t, n, r) {
        ...
        function u() {
            ...
            (app.mystories = { init: e.init, check: e.check, share: e.share, isChecking: !1, hasCheckErrors: !1, hasScanErrors: !1 }),
                app.mystories
                    .init(
                        ...
                        app.isPortal,
                        function (e, t, n) {
                            r.publish("MY-STORIES-EDIT-MEDIA", { index: e, type: t, actionId: n });
                        },
                        function (e) {
                            r.publish("MY-STORIES-EDIT-MAP", { id: e });
                        },
                        function () {
                            (app.mystories.hasCheckErrors = !1), r.publish("MY-STORIES-REFRESH");
                        },
                        function (e) {
                            (e = e || { completed: !1, ignoreAllIssues: !1 }), (app.mystories.hasCheckErrors = !e.ignoreAllIssues), (app.mystories.forcedIgnoreIssues = e.ignoreAllIssues), r.publish("MY-STORIES-REFRESH");
                        }
                    )
                    .then(a, function () {
        ...
        return { loadMyStories: i, scanStory: a, myStoriesIsSameDomain: f };
    }),
    (function () {
        "use strict";
        function e(t, r) {
...
+(function (e) {
                    ...
                    e(s).each(function () {
                        ...
                        i.hasClass("open") &&
                            ((n && "click" == n.type && /input|textarea/i.test(n.target.tagName) && e.contains(i[0], n.target)) ||
                                (i.trigger((n = e.Event("hide.bs.dropdown", s))), n.isDefaultPrevented() || (r.attr("aria-expanded", "false"), i.removeClass("open").trigger("hidden.bs.dropdown", s))));
                    }));
        }
        function r(t) {
            return this.each(function () {
                ...
                this.$element.trigger(s),
                    ...
                    ((this.isShown = !0),
                        ...
                        this.backdrop(function () {
                            ...
                            var u = e.Event("shown.bs.modal", { relatedTarget: t });
                            s
                                ? r.$dialog
        ...
        (n.VERSION = "3.3.5"),
            ...
            (n.prototype.hide = function (t) {
                ...
                return (
                    ...
                    u.isDefaultPrevented() ? void 0 : (o.removeClass("in"), e.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", r).emulateTransitionEnd(n.TRANSITION_DURATION) : r(), (this.hoverState = null), this)
                );
            }),
    ...
    define("storymaps/common/Core", [
        ...
        "lib-app/history.min",
    ], function (e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N) {
        function A(e, t) {
            var n = !1,
                r = !1;
            console.log("common.core.Core - init", t),
                ...
                a.isArcGISHosted()
                    ? (app.indexCfg = {})
                    : it() || (app.indexCfg = { proxyurl: app.indexCfg.proxyurl, sharingurl: app.indexCfg.sharingurl, username: app.indexCfg.username, password: app.indexCfg.password, oAuthAppId: app.indexCfg.oAuthAppId }),
            ...
            (document.title = app.cfg.TPL_NAME),
                ...
                b.mixin(app, { map: null, maps: {}, portal: null, builder: t, isDirectCreation: n, isGalleryCreation: r, isDirectCreationFirstSave: n, isLoading: !0, loadingTimeout: null, ui: {} }),
            ...
            if (!app.indexCfg.sharingurl) {
                ...
                if (i != -1) {
                    ...
                    (app.indexCfg.sharingurl = "//" + location.host + s + "/sharing/rest/content/items"), (app.indexCfg.proxyurl = "//" + location.host + s + "/sharing/proxy");
            ...
            L.sharinghost && (app.indexCfg.sharingurl = L.sharinghost),
                ...
                app.portal.on("load", function (e) {
                    (app.isPortal = !!e.isPortal), st(), h.checkSignInStatus(app.portal.portalUrl);
                    if (app.indexCfg.oAuthAppId) {
                        var n = new p({ appId: app.indexCfg.oAuthAppId, popup: !1, portalUrl: "https:" + app.indexCfg.sharingurl.split("/sharing/")[0] });
                        h.registerOAuthInfos([n]),
                            h.checkSignInStatus(n.portalUrl).then(
                                function () {
                                    t ? D().then(O) : D().then(O);
                                },
                                function () {
                    ...
                    j(),
                        ...
                        u.getItem(r).then(
                            function (e) {
                                ...
                                console.log('n', n)
                                app.data.addStorySection({ title: t.title, creaDate: Date.now(), status: "PUBLISHED", media: { type: "webpage", webpage: { url: n, display: "stretch", unload: !1 } }, description: t.description }),
                                    app.data.getWebAppData().setLayout({ id: "tab" }),
                                    app.data.getWebAppData().setLayoutOptions({ description: !0, legend: "panel", panel: { position: "right", size: "medium" }, panelMapOverlap: !1 }),
                                    app.data.setCurrentSectionIndex(0),
                                    g.publish("story-update-entries"),
                                    g.publish("BUILDER_INCREMENT_COUNTER", 1),
                                    F(),
                                    g.publish("CORE_UPDATE_UI"),
                                    I();
                            },
                            function () {
                                q("appLoadingFail");
            ...
            if (app.isDirectCreation && (t || i)) {
                D().then(function () {
                    ...
                    $.each(e, function (e, t) {
                        ...
                        var r = { title: "", creaDate: Date.now(), status: "PUBLISHED", media: { type: "webmap", webmap: { id: t, extent: null, layers: null, popup: null, legend: { enable: !1, openByDefault: !1 } } }, description: "" };
        ...
        function _(e) {
            u.getItem(e).then(
                function (e) {
					...
					var _token = '';
					if (savedCred && savedCred.credential && savedCred.credential.token) _token = savedCred.credential.token;
                    if (n && n.values && n.values.story && n.values.story.entries) {
                        n.values.story.entries.forEach((_item) => {
                            if (_item.media.type == "webpage") {
                                var url = _item.media.webpage.url;
                                if (url.endsWith('/')) {
                                    url = url.substring(0, url.length - 1);
                                }
                                if (_token) {
                                    if (url.indexOf('?') != -1) url = url + "&token=" + _token;
                                    else url = url + "?token=" + _token;
                                    _item.media.webpage.url = url;
                                }
                                // console.log('url', url);
                            }
                        });
                    }
                    app.data.setWebAppItem(t), app.data.getWebAppData().set(n), (app.userCanEdit = app.data.userIsAppOwner());
                    ...
                    (u && o && app.data.getWebAppData().isBlank()) || app.isGalleryCreation
                        ? (k.startFromScratch(), j())
                        : u && o
                            ? P(u)
                            : !o || (!u && o)
                                ? (j(), k.loadWebmapFromData())
                                : a.getPortalUser() || (!it() && app.data.getWebAppData().isBlank())
                                    ? Z()
        ...
        function P(e) {
            k.loadFirstWebmap(e).then(
                b.hitch(this, function (e) {
                    H(e);
                }),
        ...
        function j() {
            ...
            app.ui.headerDesktop && app.ui.headerDesktop.init(!app.isInBuilder && (app.cfg.EMBED || L.embed || L.embed === ""), e, t, X(), n, J(), app.appCfg.headerCompactByDefault),
        ...
        function F() {
            ...
            var e = L.preview === "true" || L.preview === "",
                t = L.autoplay === "true" || L.autoplay === "";
            (app.isInBuilder || app.userCanEdit) &&
                c("ie") != 9 &&
                !e &&
                !t &&
                (c("ff") && $(".builderShare #my-stories-frame").remove(), (c("ff") || !app.isInBuilder) && $("body").append('<div id="my-stories-hidden-container"><iframe id="my-stories-frame"></iframe></div>'), l.loadMyStories()),
            ...
            n && ((n = n.replace("&preview", "")), n != document.location.search && window.history.replaceState({}, "", "index.html" + n + document.location.hash));
        }
        function I() {
        ...
        function q(e, t, n) {
            ...
            tt(),
                ...
                e == "appLoadingFail"
                    ? $("#loadingMessage")
                        .html('<div id="loadingRetry"> <button type="button" class="btn btn-naked btn-sm" onclick="document.location.reload()">' + i18n.viewer.loading.failButton + " </button>" + "</div>")
                        .hide()
                    ...
                    : $("#loadingMessage").hide(),
                c("ie") == 8 &&
                ($("#fatalError-icon").css({ filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='_resources/icons/warning-icon.png', sizingMethod='scale')", backgroundPosition: "2px 3px", width: 78 }),
        ...
        function U(e, t) {
            ...
            var i = new S();
            return (
                d.defaults.geometryService.project([e], t.spatialReference, function (e) {
                    if (!e || !e[0]) return;
        ...
        function z(e, t) {
            e
                ? app.map.spatialReference.wkid != 102100 && app.map.spatialReference.wkid != 4326
                    ? d.defaults.geometryService.project([t], app.map.spatialReference, function (e) {
                        if (!e || !e[0]) return;
        ...
        function W() {
            ...
            app.ui.headerDesktop &&
                (app.ui.headerDesktop.setTitleAndSubtitle(
                    ...
                    app.ui.headerDesktop.update(X(), e, app.appCfg.headerCompactByDefault)),
                k.updateUI(),
                V();
        }
        function X(e) {
        ...
        function V() {
            ...
            i && (o = !1),
                ...
                k.resize({ isMobileView: o, isOnMobileMapView: u, width: e, height: t - n }),
        ...
        function J() {
            return !app.isInBuilder && ((!it() && !!a.getAppID(it())) || (it() && app.userCanEdit)) && (L.autoplay === undefined || L.autoplay == "false") && (L.preview === undefined || L.preview == "false");
        }
        function K() {
                ...
                ($(".esriSignInDialog").find(".dijitDialogPaneContentArea:first-child").find(":first-child").first().css("display", "none"),
                    $(".esriSignInDialog")
                        ...
                        .after(
                            ...
                            i18n.viewer.signin.explainViewer.replace("%PORTAL_LINK%", "<a href='http://" + h._arcgisUrl + "' title='" + h._arcgisUrl + "' target='_blank'>" + h._arcgisUrl + "</a>") +
                            "</div>"
                        ));
        }
        function Q() {
            h._arcgisUrl &&
                $(".esriSignInDialog")
                    ...
                    .html(i18n.viewer.signin.explainBuilder.replace("%PORTAL_LINK%", "<a href='http://" + h._arcgisUrl + "' title='" + h._arcgisUrl + "' target='_blank'>" + h._arcgisUrl + "</a>"));
        }
        function G() {
        ...
        function nt() {
            ...
            $("#loadingMessage")
                .html('<div class="mainMessage">' + i18n.viewer.loading.long + "<br />" + i18n.viewer.loading.long2 + "</div>")
        ...
        function st() {
            ...
            if (app.data.getWebAppData().getAppGeocoders) {
                ...
                app.cfg.HELPER_SERVICES.geocode &&
                    ...
                    ($.each(app.portal.helperServices.geocode, function (e, r) {
                        r.url && t.indexOf(r.url) < 0 && n.push(r);
                    }),
                        (app.cfg.HELPER_SERVICES.geocode = n));
            }
            var r;
            app.cfg.HELPER_SERVICES.geometry && app.cfg.HELPER_SERVICES.geometry.url
                ? (r = app.cfg.HELPER_SERVICES.geometry.url)
                : app.portal.helperServices.geometry && app.portal.helperServices.geometry.url && (r = app.portal.helperServices.geometry.url),
        ...
        var C = { environment: "TPL_ENV_PRODUCTION" },
            k = null,
            L = a.getUrlParams();
        return (
            i.apply(),
    ...
    define("lib-build/css!storymaps/common/ui/header/Desktop", [], function () { }),
    define("text", {}),
    function () {
        function e(e, t, n) {
            n = (n || 0) - 1;
        ...
        function a() {
            return v.pop() || { k: null, l: null, m: null, false: !1, n: 0, null: !1, number: null, object: null, push: null, string: null, true: !1, undefined: !1, o: null };
        }
        function f(e) {
        ...
        function h(n) {
            ...
            function b(e, t, n) {
                ...
                for (var o = arguments, u = 0, a = typeof n == "number" ? 2 : o.length; ++u < a;)
                    if ((i = o[u]) && X[typeof i]) for (var f = -1, l = X[typeof i] && jn(i), c = l ? l.length : 0; ++f < c;) (r = l[f]), "undefined" == typeof s[r] && (s[r] = i[r]);
                return s;
            }
            function V(e, t, n) {
                var r,
                ...
                if (3 < a && "function" == typeof o[a - 2]) var f = tt(o[--a - 1], o[a--], 2);
            ...
            function Z(e, t, n, r, i) {
                ...
                return (
                    o && (yn.call(e, "index") && (s.index = e.index), yn.call(e, "input") && (s.input = e.input)),
                    t
                        ? (r.push(e),
                            i.push(s),
                            (o ? At : d)(e, function (e, o) {
                                s[o] = Z(e, t, n, r, i);
                            }),
                            l && (f(r), f(i)),
                            s)
            ...
            function nt(e) {
                function t() {
                    ...
                    return (s || l) && (d || (d = c(arguments)), s && bn.apply(d, s), l && d.length < u)
                        ? ((r |= 16), nt([n, h ? r : -4 & r, d, null, o, u]))
                        : (d || (d = arguments), f && (n = e[p]), this instanceof t ? ((e = et(n.prototype)), (d = n.apply(e, d)), Et(d) ? d : e) : n.apply(e, d));
                }
                var n = e[0],
                    r = e[1],
                    i = e[2],
            ...
            function st(e, t, n, r, i, s) {
                ...
                if ((i.push(e), s.push(t), l)) {
                    if (((c = e.length), (p = t.length), (o = p == c) || r))
                        for (; p--;)
                            if (((l = c), (h = t[p]), r)) for (; l-- && !(o = st(e[l], h, n, r, i, s)););
                            else if (!(o = st(e[p], h, n, r, i, s))) break;
                } else
                    v(t, function (t, u, a) {
            ...
            function lt(e, t, n, r, i, s) {
                ...
                return l && !0 !== l
                    ? ((l = c(l)),
                        ...
                        !o && 1 & l[1] && (t |= 8),
                        !u || 4 & l[1] || (l[5] = s),
                        a && bn.apply(l[2] || (l[2] = []), n),
                        f && Sn.apply(l[3] || (l[3] = []), r),
                        (l[1] |= t),
                        lt.apply(null, l))
                    : (1 == t || 17 === t ? G : nt)([e, t, n, r, i, s]);
            }
            function ct(e) {
                return Fn[e];
            }
            ...
            function dt(e) {
                var t, n;
                return e && cn.call(e) == I && ((t = e.constructor), !wt(t) || t instanceof t)
                    ? (v(e, function (e, t) {
                        n = t;
                    }),
                        typeof n == "undefined" || yn.call(e, n))
                    : !1;
            }
            function vt(e) {
                return In[e];
            ...
            function Nt(e, t, n) {
                ...
                return (
                    ...
                    Bn(e)
                        ? (o = -1 < i(e, t, n))
                        : typeof s == "number"
                            ? (o = -1 < (xt(e) ? e.indexOf(t, n) : i(e, t, n)))
                            : d(e, function (e) {
            ...
            function Ct(e, t, n) {
                ...
                var i = e ? e.length : 0;
                if (typeof i == "number") for (; ++n < i && (r = !!t(e[n], n, e)););
                else
                    d(e, function (e, n, i) {
                        return (r = !!t(e, n, i));
                    });
            ...
            function At(e, t, n) {
                var r = -1,
                    i = e ? e.length : 0;
                if (((t = t && typeof n == "undefined" ? t : tt(t, n, 3)), typeof i == "number")) for (; ++r < i && !1 !== t(e[r], r, e););
                else d(e, t);
                return e;
            }
            function Ot(e, t, n) {
                var r = e ? e.length : 0;
                if (((t = t && typeof n == "undefined" ? t : tt(t, n, 3)), typeof r == "number")) for (; r-- && !1 !== t(e[r], r, e););
                else {
                    var i = jn(e),
                        r = i.length;
                    d(e, function (e, n, s) {
            ...
            function Mt(e, t, n) {
                var r = -1,
                    i = e ? e.length : 0;
                if (((t = K.createCallback(t, n, 3)), typeof i == "number")) for (var s = Gt(i); ++r < i;) s[r] = t(e[r], r, e);
                else
                    (s = []),
                        d(e, function (e, n, i) {
                            s[++r] = t(e, n, i);
            ...
            function Dt(e, t, n, r) {
                ...
                var s = -1,
                    o = e.length;
                if (typeof o == "number") for (i && (n = e[++s]); ++s < o;) n = t(n, e[s], s, e);
                else
                    d(e, function (e, r, s) {
                        n = i ? ((i = !1), e) : t(n, e, r, s);
                    });
            ...
            function Xt(e, t, n) {
                ...
                if (((t = An(0, t) || 0), !0 === n))
                    var m = !0,
                        v = !1;
                else Et(n) && ((m = n.leading), (d = "maxWait" in n && (An(t, n.maxWait) || 0)), (v = "trailing" in n ? n.trailing : v));
                return function () {
                    if (((s = arguments), (a = $n()), (f = this), (c = v && (l || !m)), !1 === d)) var n = m && !l;
                    else {
                        o || m || (h = a);
                        var p = d - (a - h),
                            g = 0 >= p;
            ...
            (Pn.funcDecomp = !pt(n.a) && O.test(h)),
                ...
                (K.templateSettings = { escape: /<%-([\s\S]+?)%>/g, evaluate: /<%([\s\S]+?)%>/g, interpolate: k, variable: "", imports: { _: K } }),
                Tn ||
                (et = (function () {
                    function e() { }
                    return function (t) {
            ...
            return (
                ...
                (K.merge = function (e) {
                    var t = arguments,
                        n = 2;
                    if (!Et(e)) return e;
                    if (("number" != typeof t[2] && (n = t.length), 3 < n && "function" == typeof t[n - 2])) var r = tt(t[--n - 1], t[n--], 2);
                ...
                (K.isEmpty = function (e) {
                    ...
                    var n = cn.call(e),
                        r = e.length;
                    return n == P || n == R || n == D || (n == I && typeof r == "number" && wt(e.splice))
                        ? !r
                        : (d(e, function () {
                            return (t = !1);
                        }),
                ...
                (K.now = $n),
                (K.parseInt = Jn),
                (K.random = function (e, t, n) {
                    var r = null == e,
                        i = null == t;
                    return (
                        null == n && (typeof e == "boolean" && i ? ((n = e), (e = 1)) : i || typeof t != "boolean" || ((n = t), (i = !0))),
                        r && i && (t = 1),
                        (e = +e || 0),
                        i ? ((t = e), (e = 0)) : (t = +t || 0),
                        n || e % 1 || t % 1 ? ((n = _n()), On(e + n * (t - e + parseFloat("1e-" + ((n + "").length - 1))), t)) : ut(e, t)
                    );
                }),
                (K.reduce = Dt),
                (K.reduceRight = Pt),
                ...
                (K.prototype.value = Qt),
                (K.prototype.valueOf = Qt),
                At(["join", "pop", "shift"], function (e) {
                    var t = an[e];
        ...
        var z = { leading: !1, maxWait: 0, trailing: !1 },
            W = { configurable: !1, enumerable: !1, value: null, writable: !1 },
    ...
    (function (e) {
        ...
        else if (typeof define == "function" && define.amd) define("lib-app/clipboard/clipboard", [], e);
        else {
            var t;
            typeof window != "undefined" ? (t = window) : typeof global != "undefined" ? (t = global) : typeof self != "undefined" ? (t = self) : (t = this), (t.Clipboard = e());
        }
    })(function () {
        var e, t, n;
        return (function r(e, t, n) {
        ...
        })(
            {
                ...
                5: [
                    function (e, t, n) {
                        function r(e) {
                            ...
                            else if (e.nodeName === "INPUT" || e.nodeName === "TEXTAREA") e.focus(), e.setSelectionRange(0, e.value.length), (t = e.value);
                            else {
                ...
                7: [
                    function (t, n, r) {
                        (function (i, s) {
                            if (typeof e == "function" && e.amd) e(["module", "select"], s);
                            else if (typeof r != "undefined") s(n, t("select"));
                            else {
                                var o = { exports: {} };
                                s(o, i.select), (i.clipboardAction = o.exports);
                            }
                        })(this, function (e, t) {
                            "use strict";
                            function r(e) {
                                    ...
                                    return (
                                        o(e, [
                                            ...
                                            },
                                            {
                                                ...
                                                set: function (t) {
                                                    if (t !== undefined) {
                                                        if (!t || (typeof t == "undefined" ? "undefined" : i(t)) !== "object" || t.nodeType !== 1) throw new Error('Invalid "target" value, use a valid Element');
                                                        if (this.action === "copy" && t.hasAttribute("disabled")) throw new Error('Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute');
                ...
                8: [
                    function (t, n, r) {
                        (function (i, s) {
                            if (typeof e == "function" && e.amd) e(["module", "./clipboard-action", "tiny-emitter", "good-listener"], s);
                            else if (typeof r != "undefined") s(n, t("./clipboard-action"), t("tiny-emitter"), t("good-listener"));
                            else {
                                var o = { exports: {} };
                                s(o, i.clipboardAction, i.tinyEmitter, i.goodListener), (i.clipboard = o.exports);
                            }
                                            ...
                                            },
                                            {
                                                ...
                                                value: function (t) {
                                                    ...
                                                    this.clipboardAction && (this.clipboardAction = null),
                                                        (this.clipboardAction = new i.default({ action: this.action(n), target: this.target(n), text: this.text(n), trigger: n, emitter: this }));
                                                },
                                            },
                                            {
                                                key: "defaultAction",
    ...
    define("storymaps/common/ui/share/ShareURLPanel", [
        ...
        return function (i) {
            function a(e, t) {
                o.val(e),
                    i.find(".btn-bitlylink-open").attr("href", e),
                    n.requestShortUrl(e).then(function (e) {
                        o.val(e), (t === undefined || t === !0) && o.select();
                    });
                var s = new r(i.find(".share-btn").get(0), {
                    text: function () {
                        return i.find(".bitlylink").val();
                    },
                });
                s.on("success", function () {
                    i.find(".share-btn").removeClass("share-clipboard").addClass("share-ok"),
                        i.find(".share-status").show(),
                        (i.find(".bitlylink")[0].selectionStart = i.find(".bitlylink")[0].selectionEnd = -1),
                        i.find(".bitlylink").focus(),
                        setTimeout(function () {
            ...
            function f() {
                i.find(".bitlylink").click(function () {
                    this.setSelectionRange(0, this.value.length);
                });
            }
            var s = document.queryCommandSupported("copy");
            i.append(e({}));
            var o = i.find(".bitlylink"),
                u = null;
            f(),
                (this.present = function (e, t) {
                    (u = n.cleanURL(e, !0)),
                        a(u, t),
                        i.find(".btn-bitlylink-open").html(i18n.viewer.shareFromCommon.open),
                        i.find(".share-url-container").toggleClass("touch", !s),
                        i.find(".share-btn").attr("title", i18n.viewer.shareFromCommon.copy),
                        i.find(".share-status").html(i18n.viewer.shareFromCommon.copied);
                }),
                (this.focus = function () {
                    o.select();
                }),
    ...
    define("storymaps/common/ui/share/ShareEmbedPanel", [
        ...
        return function (r) {
            function a() {
                $.each(s, function (e, t) {
                    r.find(".embed-sizes").append('<li><a data-width="' + t.width + '" data-height="' + t.height + '">' + t.width + " / " + t.height + "</a></li>");
                }),
                    r.find(".embed-sizes a").click(function () {
                        var e = $(this);
                        e.parents(".btn-group").find(".embed-sizes-btn").text(e.text()), f(e.data("width"), e.data("height"));
                    });
            }
            function f(e, t) {
                r.find(".embedTextarea").val(i.replace("%URL%", o).replace("%WIDTH%", e).replace("%HEIGHT%", t));
                var s = new n(r.find(".share-btn").get(0), {
                    text: function () {
                        return r.find(".embedTextarea").val();
                    },
                });
                s.on("success", function () {
                    r.find(".share-btn").removeClass("share-clipboard").addClass("share-ok"),
                        r.find(".share-status").show(),
                        (r.find(".embedTextarea")[0].selectionStart = r.find(".embedTextarea")[0].selectionEnd = -1),
                        r.find(".bitlylink").focus(),
                        setTimeout(function () {
                            r.find(".share-btn").addClass("share-clipboard").removeClass("share-ok"), r.find(".share-status").hide();
                        }, 2e3);
                });
            }
            function l() {
                r.find(".embedTextarea").click(function () {
                    this.setSelectionRange(0, this.value.length);
                });
            }
            ...
            r.append(e({})),
                ...
                (this.present = function (e) {
                    ...
                    (u = e),
                        (o = e),
                        r.find(".embed-explain").html(i18n.viewer.shareFromCommon.embedExplain),
                        r.find(".embed-lbl-size").html(i18n.viewer.shareFromCommon.size),
                        r.find(".embed-sizes a").eq(0).click(),
                        r.find(".share-embed-wrapper").toggleClass("touch", !t),
                        r.find(".share-clipboard").attr("title", i18n.viewer.shareFromCommon.copy),
                        r.find(".share-status").html(i18n.viewer.shareFromCommon.copied);
                }),
                (this.setAutoplay = function (e) {
                    var t = u;
                    e && ((t += t.match(/\?/) ? "&" : "?"), (t += "autoplay")), (o = t), r.find(".embed-sizes a").eq(0).click();
                });
        };
    }),
    define("storymaps/common/ui/share/ShareDialog", ["lib-build/tpl!./ShareDialog", "lib-build/css!./ShareDialog", "./ShareURLPanel", "./ShareEmbedPanel", "../../utils/SocialSharing"], function (e, t, n, r, i) {
        return function (s) {
            function a(e) {
                ...
                s.find(".share_facebook").toggle(e.facebook),
                    e.facebook &&
                    s
                        .find(".share_facebook")
                        .off("click")
                    ...
                    s.find(".share_twitter").toggle(e.twitter),
                    e.twitter &&
                    s
                        .find(".share_twitter")
                        .off("click")
            ...
            s.on("shown.bs.modal", function () {
                ...
                s.find(".autoplay-checkbox").change(function () {
                    o.setAutoplay(!!this.checked),
                        ...
                        s.find(".autoplay-notification").html(i18n.viewer.shareFromCommon.linksupdated).fadeIn(),
                        setTimeout(function () {
                            s.find(".autoplay-notification").fadeOut();
                        }, 1e3);
                }),
                (this.present = function (e, t) {
                    (t = t || { facebook: !1, twitter: !1 }),
                        s.find(".social-container").toggle(t.facebook || t.twitter),
                        a(t),
                        o.present(e),
                        u.present(e),
                        s.find(".modal-title").html(i18n.viewer.headerFromCommon.share),
                        s.find(".embed-title").html(i18n.viewer.shareFromCommon.embed),
                        s.find(".btn-close").html(i18n.viewer.common.close),
                        s.find(".autoplay-label").html(i18n.viewer.shareFromCommon.autoplayLabel),
                        s.find(".autoplay-help").tooltip({ title: i18n.viewer.shareFromCommon.autoplayExplain1 + "<br /><br />" + i18n.viewer.shareFromCommon.autoplayExplain2, html: !0 }),
                        s.find(".autoplay-checkbox").prop("checked", !1),
                        s.modal({ keyboard: !0 }),
                        app.appCfg.disableAutoPlay && s.find(".autoplay-container").hide();
                });
        };
    }),
    define("storymaps/common/utils/HeaderHelper", ["./SocialSharing", "../ui/share/ShareDialog", "storymaps/common/utils/CommonHelper"], function (e, t, n) {
        function i(e) {
            e.find(".linkContainer").parent().length &&
                e
                    .find(".linkContainer")
                    .css("width", (e.find(".logoContainer").position() || { left: 186 }).left - e.find(".linkContainer").parent().position().left - e.find(".shareBtns").outerWidth() - ($(".logoContainer").width() > 1 ? 14 : 4));
        }
        var r = new t($("#shareDialog"));
        return {
            setLogo: function (e, t, r) {
                if (!t.logoURL || t.logoURL == "NO_LOGO") e.find(".logoImg").hide(), i(e);
                else {
                    var s = e.find(".logoLink");
                    t.logoTarget ? s.css("cursor", "pointer").attr("href", t.logoTarget) : s.css("cursor", "default").removeAttr("href"), i(e);
                    var o = e.find(".logoImg");
                    (o[0].onload = function () {
                        i(e), r && typeof r == "function" && r();
                    }),
                        (o[0].onerror = function () {
                            i(e);
                        }),
                        o.attr("src", n.possiblyAddToken(t.logoURL)).show();
                }
            },
            ...
            setSocial: function (e, t) {
                ...
                e.find(".share_facebook").toggleClass("active", i),
                    e.find(".share_twitter").toggleClass("active", s),
                    e.find(".share_bitly").toggleClass("active", o),
                    e
                        .find(".share-all")
                        .data("share-facebook", i)
                        .data("share-twitter", s)
                        .toggleClass("active", i || s || o);
            },
            toggleSocialBtnAppSharing: function (e, t) {
                t && e.find(".shareIcon").attr("title", ""),
                    e
                        ...
                        .tooltip(t ? { title: i18n.commonCore ? i18n.commonCore.builderPanel.tooltipNotShared : "", container: "body" } : "destroy");
            },
            disableSocialBtnAppSharingAutoplay: function (e, t) {
                e.find(".shareIcon").attr("title", ""),
                    e
                        ...
                        .tooltip({ title: i18n.viewer.headerFromCommon.tooltipAutoplayDisabled, container: "body", placement: t ? t : "bottom" });
            },
                ...
                t
                    ...
                    t
                        ...
                        .click(function () {
                            if ($(this).hasClass("disabled")) return;
                            var t = $(this).data("url") || document.location.href;
                            r.present(e.cleanURL(t, !0), { facebook: !!$(this).data("share-facebook"), twitter: !!$(this).data("share-twitter") });
                        }),
                    t
    ...
    define("storymaps/common/builder/InlineFieldEdit", ["lib-build/css!./InlineFieldEdit", "dojo/has"], function (e, t) {
        return function (n, r, i) {
            function o(e, t, n) {
                if (!e || !t || !n) return;
            ...
            function u(e) {
                ...
                var n = e.get(0).value,
                    ...
                    u = r.parent().first();
                n === "" && ($(e).parents("h1.title") ? (n = i18n.commonCore.inlineFieldEdit.enterTitle) : (n = i18n.commonCore.inlineFieldEdit.enterSubtitle)),
                    (n = n.replace(/<\/?script>/g, "")),
                    r.parent().parent().removeClass("isEditing"),
                    r.html(n),
                    r.show(),
                    e.hide(),
                    o.css("display", "inline-block"),
                    t("ios") && document.activeElement.blur(),
                    typeof i == "function" && i(u, n);
            }
            var s = null;
        ...
        return function (o, u) {
            ...
            function l(e) {
                if (!app.appCfg.noAppThemes) {
                    ...
                    var t = o.find(".subtitle");
                    e.name.match(/-org$|-modified$/) ? t.css({ color: e.headerTitle, opacity: 0.8 }) : t.removeAttr("style");
                }
            }
            function c(e, n) {
                var r = e.compactSize === undefined ? n : e.compactSize;
                t.setLogo(o, e, a.resize),
                    t.setLink(o, e),
                    t.setSocial(o, e),
                    t.initEvents(o, "bottom"),
                    o.toggleClass("compact", r),
                    r &&
                    (o.find(".rightArea").hide(),
                        setTimeout(function () {
                ...
                t.off("click").removeClass("forceEvent").show(),
                    ...
                    e == "start"
                        ? t
                            ...
                            .css("cursor", "default")
                        : e == "error"
                            ? t.html(i18n.viewer.headerFromCommon.fix).append(n).css("cursor", "pointer").click(r.switchToBuilder).removeClass("btn-warning").addClass("btn-danger")
                            : t.html(i18n.viewer.headerFromCommon.noerrors).append(n).removeClass("btn-warning").addClass("btn-success"),
                    (i("ff") || i("ie") || i("trident") == 7) && e != "error" && t.click(h).addClass("forceEvent");
                var u = o
                    .find(".share-story")
                    ...
                    a = u.css("background-color");
                if (!app.appCfg.noAppThemes) {
                    var f = app.data.getWebAppData().getTheme().colors;
                    a && f && f.header && r.colorsAreSimilar(a, f.header, !0) && u.css("box-shadow", "0 0 2px 1px white");
                }
            }
            function v() { }
            function m(e, t) {
                setTimeout(
                    function () {
                        s.publish("HEADER_EDITED", { src: $(e).attr("class").split(" ")[0], value: t }), $(e).removeClass("error");
                    },
                    i("ios") || i("ie") >= 10 ? 700 : 0
                ),
            ...
            (this.init = function (e, t, a, f, h, p, g) {
                ...
                u &&
                    (o.addClass("isBuilder"),
                        (t = "<div class='text_edit_label'>" + (t || i18n.commonCore.inlineFieldEdit.enterTitle) + "</div>"),
                        (t += "<div class='text_edit_icon' title='" + i18n.commonCore.header.title.replace("%TPL_NAME%", app.cfg.TPL_NAME) + "'></div>"),
                        (t += "<textarea rows='1' class='text_edit_input form-control' type='text' spellcheck='true'></textarea>"),
                        (a = "<span class='text_edit_label'>" + (a || i18n.commonCore.inlineFieldEdit.enterSubtitle) + "</span>"),
                        (a += "<div class='text_edit_icon' title='" + i18n.commonCore.header.subtitle.replace("%TPL_NAME%", app.cfg.TPL_NAME) + "'></div>"),
                        (a += "<textarea rows='3' class='text_edit_input form-control' type='text' spellcheck='true'></textarea>")),
                    o.find(".title").html(t),
                    o.find(".subtitle").html(a),
                    u && new n(o, v, m);
                if (!u && !a) {
                    var y = f.compactSize === undefined ? g : f.compactSize;
                    y || (o.find(".title").css({ paddingTop: 30, height: 90 }), o.find(".subtitle").css("height", 32).attr("tabindex", "-1"));
                }
                if (p) {
                    var b = o
                        .find(".switchBuilder")
                        ...
                        .click(r.switchToBuilder)
                        .show(),
                        w = b.css("background-color");
                    if (!app.appCfg.noAppThemes) {
                        var E = app.data.getWebAppData().getTheme().colors;
                        w && E && E.header && r.colorsAreSimilar(w, E.header, !0) && b.css("box-shadow", "0 0 2px 1px white");
                    }
                    i("ff") || i("ie") || i("trident") == 7
                        ? b.find(".switch-builder-close").hide()
                        : b.find(".switch-builder-close").click(function () {
                            return b.hide(), $(window).resize(), !1;
                        });
                }
                var S = r.getUrlParams(),
                    x = S.preview === "true" || S.preview === "",
                    T = S.autoplay === "true" || S.autoplay === "";
                !app.isInBuilder && app.userCanEdit && i("ie") != 9 && !x && !T && (o.find(".error-status").addClass("enabled"), s.subscribe("MYSTORIES_SCAN", d), d("start")), c(f, g);
            }),
                ...
                (this.setTitleAndSubtitle = function (e, t) {
                    var n = u ? i18n.commonCore.inlineFieldEdit.enterTitle : "",
                        r = u ? i18n.commonCore.inlineFieldEdit.enterSubtitle : "";
                    o.find(".title" + (u ? " .text_edit_label" : "")).html(e || n), o.find(".subtitle" + (u ? " .text_edit_label" : "")).html(t || r);
                }),
    ...
    define("lib-build/tpl!storymaps/tpl/ui/MainMediaContainerMap", [], function () {
        return function (obj) {
            ...
            with (obj)
            __p +=
                '<div class="mainMediaContainer">\n    <div class="mapContainer" data-webmapid="' +
                ((__t = webmapid) == null ? "" : __t) +
                '" data-temporary="' +
                ((__t = isTemporary) == null ? "" : __t) +
                '"></div>\n	<div class="overview"></div>\n	<div class="legend"></div>\n	<div class="geocoder"></div>\n	<div class="mainStageErrorContainer">\n		<div class="error"></div>\n	</div>\n	\n	<div class="mobilePopup mobileInfo hideContent">\n		<div class="content-toggles">\n			<div class="btn-group">\n				<button type="button" class="btn btn-default" data-value="description">' +
                ((__t = lblDescription) == null ? "" : __t) +
                '</button>\n				<button type="button" class="btn btn-default" data-value="legend">' +
                ...
                '\n				</div>\n				<div class="legendMobileErrorExplain">' +
                ((__t = lblLegendMobileErrorExplain) == null ? "" : __t) +
    ...
    define("lib-build/tpl!storymaps/tpl/ui/MainMediaContainerImage", [], function () {
        return function (obj) {
            ...
            with (obj)
            __p +=
                '<div class="mainMediaContainer">\n    <div class="imgContainer" data-src="' +
                ((__t = url) == null ? "" : __t) +
    ...
    define("storymaps/tpl/core/WebApplicationData", ["dojo/_base/lang", "storymaps/common/utils/CommonHelper"], function (e, t) {
        var n = {},
            r = { values: {} };
        return {
            set: function (t) {
            ...
            get: function () {
                var t = e.clone(r);
                return (t.values.template = t.values.template || {}), (t.values.template = { name: t.values.template.name || app.cfg.TPL_NAME, createdWith: t.values.template.createdWith || app.version, editedWith: app.version }), t;
            },
            getOriginalData: function () {
                return n;
            },
            isBlank: function () {
                return Object.keys(r.values).length <= 1 || app.data.getStoryEntries().length === 0;
            },
            getBlank: function () {
                return { values: { webmap: n.values.webmap } };
            },
            ...
            cleanWebAppAfterInitialization: function () {
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    s &&
                        s.values &&
                        (s.values.order && (delete s.values.order, (e = !0)),
                            s.values.firstRecordAsIntro && (delete s.values.firstRecordAsIntro, (e = !0)),
                            s.values.fieldsOverride && (delete s.values.fieldsOverride, (e = !0)),
                            s.values.sourceLayer && (delete s.values.sourceLayer, (e = !0)));
                }
                return e;
            },
            ...
            setLayout: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.layout = e);
            },
            ...
            getLayoutOptions: function () {
                ...
                return (
                    (t.panel = this.getPanelCfg()),
                    t.description === undefined && (this.getLayoutId() == "tab" || this.getLayoutId() == "bullet") && (t.description = !0),
                    this.getLayoutId() == "accordion" && t.numbering === undefined && (t.numbering = !0),
                    this.getLayoutId() == "bullet" ? (t.legend = "panel") : this.getLayoutId() == "accordion" && (t.legend = "dropdown"),
                    t
                );
            },
            setLayoutOptions: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.layoutOptions = e);
            },
            setDefaultLayoutOptions: function () {
                this.getLayoutId() == "tab"
                    ? this.setLayoutOptions({ description: !0, legend: "panel", panel: { position: "left", size: "medium" }, panelMapOverlap: !1 })
                    : this.getLayoutId() == "accordion" && this.setLayoutOptions({ description: !0, legend: "dropdown", panel: { position: "left", size: "medium" }, numbering: !0, reverse: !1 }),
                    this.getLayoutId() == "bullet" && this.setLayoutOptions({ description: !0, legend: "panel", panel: { position: "left", size: "medium" }, reverse: !1, panelMapOverlap: !1 });
            },
            ...
            getPanelCfg: function () {
                var e = {},
                    t = (this.getSettings().layoutOptions || {}).panel || {},
            ...
            setTheme: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.theme = e);
            },
            getColors: function () {
            ...
            setHeader: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.header = e);
            },
            ...
            getLogoURL: function (e) {
                var n = this.getHeader().logoURL ? this.getHeader().logoURL : app.cfg.HEADER_LOGO_URL;
                return (
                    n == app.cfg.HEADER_LOGO_URL &&
                    this.getColors() &&
                    (e ? this.getColors().esriLogoMobile == "white" && (n = "resources/tpl/viewer/icons/esri-logo-white.png") : this.getColors().esriLogo == "white" && (n = "resources/tpl/viewer/icons/esri-logo-white.png")),
                    t.possiblyRemoveToken(n)
                );
            },
            ...
            setAppGeocoders: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.appGeocoders = e);
            },
            getStory: function () {
            ...
            setStoryEntries: function (e) {
                (r.values.story = r.values.story || {}), (r.values.story.storage = "WEBAPP"), (r.values.story.entries = e);
            },
            getMapOptions: function () {
                var t = e.clone(this.getSettings().mapOptions) || {};
                return t.mapsSync === undefined && (t.mapsSync = !0), t;
            },
            getGeocoder: function () {
                return !!this.getMapOptions().geocoder && !!this.getMapOptions().geocoder.enable;
            },
            setMapOptions: function (e) {
                (r.values.settings = r.values.settings || {}), (r.values.settings.mapOptions = e);
            },
        };
    }),
    define("storymaps/tpl/core/Helper", ["./WebApplicationData", "esri/geometry/Extent"], function (e, t) {
        return {
            getLayoutExtent: function (n, r, i) {
                var s = $("body").hasClass("layout-tab-left") || $("body").hasClass("layout-bullet-left"),
                    o = $("body").hasClass("layout-tab-right") || $("body").hasClass("layout-bullet-right");
                console.log("tpl.core.Helper - getLayoutExtent", r, s, o, e.getPanelMapOverlap());
                if (!n) return n;
                if (!s && !o) return n;
                if (e.getPanelMapOverlap()) return n;
                var u = 0,
                    a = 0,
                    f = 0;
                s ? (a = $("#descLegendPanel").outerWidth()) : o && (f = $("#descLegendPanel").outerWidth()), r ? (u = n.getWidth() / $("body").width()) : (u = n.getWidth() / ($("body").width() - a - f));
                var l = u * a,
                    c = u * f;
                r && ((l *= -1), (c *= -1));
                var h = new t({ xmin: n.xmin - l, ymin: n.ymin, xmax: n.xmax + c, ymax: n.ymax, spatialReference: n.spatialReference });
                if (i) {
                    var p = new esri.layers.GraphicsLayer();
                    p.add(new esri.Graphic(n, new esri.symbol.SimpleFillSymbol().setColor(new esri.Color([255, 0, 0, 0.5])))), p.add(new esri.Graphic(h, new esri.symbol.SimpleFillSymbol())), app.map.addLayer(p);
                }
                return h;
            },
        };
    ...
    (function (e, t, n) {
        ...
        function Y(t, n) {
            n !== Object(n) && (n = {}),
                ...
                (this.value = function (t) {
                    var i;
                    return (
                        this.cache[t] === undefined && ((i = e(this.el).attr("data-cbox-" + t)), i !== undefined ? (this.cache[t] = i) : n[t] !== undefined ? (this.cache[t] = n[t]) : r[t] !== undefined && (this.cache[t] = r[t])),
                        this.cache[t]
                    );
                }),
                (this.get = function (t) {
        ...
        function at(n) {
            ...
            z ||
                ((r = e(n).data("colorbox")),
                    ...
                    ((R = U = !0),
                        it(P.get("className")),
                        d.css({ visibility: "hidden", display: "block", opacity: "" }),
                        (x = Q(V, "LoadedContent", "width:0; height:0; overflow:hidden; visibility:hidden")),
                        m.css({ width: "", height: "" }).append(x),
                        (H = g.height() + w.height() + m.outerHeight(!0) - m.height()),
                        (B = y.width() + b.width() + m.outerWidth(!0) - m.width()),
                        (j = x.outerHeight(!0)),
                        (F = x.outerWidth(!0)),
                        (P.w = et(P.get("initialWidth"), "x")),
                        (P.h = et(P.get("initialHeight"), "y")),
                        x.css({ width: "", height: P.h }),
                        X.position(),
                        ot(u),
                        P.get("onOpen"),
                        _.add(C).hide(),
                    ...
                    p.css({ opacity: parseFloat(P.get("opacity")) || "", cursor: P.get("overlayClose") ? "pointer" : "", visibility: "visible" }).show(),
                    P.get("closeButton") ? M.html(P.get("close")).appendTo(m) : M.appendTo("<div/>"),
                    ct());
        }
        function ft() {
            !d &&
                ...
                ((K = !1),
                    (S = e(n)),
                    (d = Q(V)
                        .attr({ id: i, class: e.support.opacity === !1 ? s + "IE" : "", role: "dialog", tabindex: "-1" })
                        .hide()),
                    (p = Q(V, "Overlay").hide()),
                    (N = e([Q(V, "LoadingOverlay")[0], Q(V, "LoadingGraphic")[0]])),
                    (v = Q(V, "Wrapper")),
                    (m = Q(V, "Content").append(
                        (C = Q(V, "Title")),
                        (k = Q(V, "Current")),
                        (O = e('<button type="button"/>').attr({ id: s + "Previous" })),
                        (A = e('<button type="button"/>').attr({ id: s + "Next" })),
                        (L = Q("button", "Slideshow")),
                        N
                    )),
                    (M = e('<button type="button"/>').attr({ id: s + "Close" })),
                    v
                        .append(
                            Q(V).append(Q(V, "TopLeft"), (g = Q(V, "TopCenter")), Q(V, "TopRight")),
                            Q(V, !1, "clear:left").append((y = Q(V, "MiddleLeft")), m, (b = Q(V, "MiddleRight"))),
                            Q(V, !1, "clear:left").append(Q(V, "BottomLeft"), (w = Q(V, "BottomCenter")), Q(V, "BottomRight"))
                        )
                        .find("div div")
                        .css({ float: "left" }),
                    (T = Q(V, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;")),
                    ...
                    : P.get("iframe")
                        ...
                        : P.get("html")
                            ...
                            : tt(P, r)
                                        ...
                                        .one("load", function () {
                                            ...
                                            e.each(["alt", "longdesc", "aria-describedby"], function (t, n) {
                                                ...
                                                ((i = function () {
                                                    ...
                                                    P.mw && q.width > P.mw && ((t = (q.width - P.mw) / q.width), i()),
                                                    P.mh && q.height > P.mh && ((t = (q.height - P.mh) / q.height), i())),
                                ...
                                : r &&
                                T.load(r, P.get("data"), function (t, n) {
        ...
        var r = {
            ...
            ut = (function () {
                ...
                function o() {
                    if (P.get("loop") || E[I + 1]) i(), (r = setTimeout(X.next, P.get("slideshowSpeed")));
                }
                function u() {
        ...
        e(ft),
            ...
            (X.position = function (t, n) {
                ...
                S.unbind("resize." + s),
                    ...
                    (a = S.scrollTop()),
                    (f = S.scrollLeft()),
                    P.get("fixed") ? ((u.top -= a), (u.left -= f), d.css({ position: "fixed" })) : ((i = a), (o = f), d.css({ position: "absolute" })),
                    ...
                    d.css({ top: u.top, left: u.left, visibility: "visible" }),
                    (v[0].style.width = v[0].style.height = "9999px"),
                    (r = { width: P.w + F + B, height: P.h + j + H, top: i, left: o });
                if (t) {
                    var c = 0;
                    e.each(r, function (e) {
                        if (r[e] !== J[e]) {
            ...
            (X.resize = function (e) {
                ...
                R &&
                    ((e = e || {}),
                        e.width && (P.w = et(e.width, "x") - F - B),
                        e.innerWidth && (P.w = et(e.innerWidth, "x")),
                        x.css({ width: P.w }),
                        e.height && (P.h = et(e.height, "y") - j - H),
                        e.innerHeight && (P.h = et(e.innerHeight, "y")),
                        !e.innerHeight && !e.height && ((t = x.scrollTop()), x.css({ height: "auto" }), (P.h = x.height())),
                        x.css({ height: P.h }),
                        t && x.scrollTop(t),
                        X.position(P.get("transition") === "none" ? 0 : P.get("speed")));
            }),
            (X.prep = function (n) {
                function u() {
                ...
                x.remove(),
                    ...
                    x
                        .hide()
                        .appendTo(T.show())
                        .css({ width: u(), overflow: P.get("scrolling") ? "auto" : "hidden" })
                        .css({ height: a() })
                        .prependTo(m),
                    T.hide(),
                    e(q).css({ float: "none" }),
                        ...
                        (u = function () {
                            ...
                            n > 1
                                ? (typeof P.get("current") == "string" &&
                                    k
                                        ...
                                        .show(),
                                    A[P.get("loop") || I < n - 1 ? "show" : "hide"]().html(P.get("next")),
                                    O[P.get("loop") || I ? "show" : "hide"]().html(P.get("previous")),
                                    ut(),
                                    P.get("preloading") &&
                            ...
                            P.get("iframe")
                                ? ((r = t.createElement("iframe")),
                                    ...
                                    P.get("scrolling") || (r.scrolling = "no"),
                                    e(r)
                                        .attr({ src: P.get("href"), name: new Date().getTime(), class: s + "Iframe", allowFullScreen: !0 })
                                        .one("load", u)
                                        .appendTo(x),
                                    D.one(h, function () {
                                        r.src = "//about:blank";
                                    }),
                                    P.get("fastIframe") && e(r).trigger("load"))
                                : u(),
                            P.get("transition") === "fade" ? d.fadeTo(o, 1, a) : a();
                    }),
                    P.get("transition") === "fade"
                        ? d.fadeTo(o, 0, function () {
                            X.position(0, r);
                        })
                        : X.position(o, r);
            }),
            ...
            (X.close = function () {
                R &&
                    ...
                    ((z = !0),
                        ...
                        P.get("onCleanup"),
                        S.unbind("." + s),
                        p.fadeTo(P.get("fadeOut") || 0, 0),
                        d.stop().fadeTo(P.get("fadeOut") || 0, 0, function () {
                            d.hide(),
                                p.hide(),
                                ot(h),
                                x.remove(),
    ...
    define("storymaps/tpl/ui/StoryText", [
        "dojo/topic",
        ...
        function u(e) {
            ...
            return (
                (t = $(t)),
                t.find(".description > *").each(function (e, t) {
                    var n = $(t);
        ...
        function a(e) {
            var t = $(e);
            return (
                t.find("iframe").each(function (e, t) {
                    var n = $(t),
                        r = n.attr("data-unload");
                    n.attr("data-src", n.attr("src"))
                        .attr("data-unload", r === undefined || r == "true")
                        .removeAttr("src");
                }),
                t
            );
        ...
        function l() {
            c($(".descLegendPanel .textEditorContent"), $(".descLegendPanel").width() - 40), c($(".accordionPanel .textEditorContent"), $(".accordionPanel").width() - 34);
        }
        function c(e, t) {
        ...
        function p(e) {
            ...
            (o = !0),
                $.colorbox({ href: n.attr("src"), photo: !0, title: n.parents("figure").find("figcaption").html() || n.attr("title"), scalePhotos: !0, maxWidth: "90%", maxHeight: "90%" }),
                setTimeout(function () {
                    o = !1;
                }, 800);
        }
        function d() {
            $(".textEditorContent img").each(function (e, t) {
                var n = !!$(t).attr("width"),
                    r = $(t).css("float") == "right";
                $(t)
                    .parent()
                    .css("position", "relative")
                    .addClass(n ? "has-width" : "no-width")
                    .addClass(r ? "float-right" : ""),
                    $(t).wrap("<div class='image-wrapper'></div>").after($('<span class="btn-fullscreen"></span>').click(p)).click(p);
            }),
                $(document).unbind("cbox_complete", v).bind("cbox_complete", v);
        }
        function v() {
        ...
        function m(o) {
            var u = app.data.getCurrentSection() && app.data.getCurrentSection().media,
                a = u && u.type == "webmap",
                f = a ? app.map.extent : null,
                l = a ? u.webmap.id : null;
            $(".mediaBackContainer").hide();
            if (o.type == "media") {
                var c = o.media.type == "webmap",
                    h = !!c && !!o.media.webmap.extent,
                    p = !!c && !!o.media.webmap.layers,
                    d = !!c && !!o.media.webmap.popup;
                e.publish("story-perform-action-media", o.media);
                if (h && !p && !d && l == o.media.webmap.id)
                    var v = e.subscribe("story-loaded-map", function () {
                        v.remove(),
                            setTimeout(function () {
                                var e = app.map.on("update-end", function () {
                                    e.remove(), $(".mediaBackContainer").fadeOut().off("click");
                                });
                ...
                $(".backButton")
                    .off("click")
                    .click(function () {
                        if (a && (!c || l != o.media.webmap.id)) e.publish("ADDEDIT_SHOW_WEBMAP", l);
                        else if (a && c && l == o.media.webmap.id) {
                            (h || d) &&
                                app.map.setExtent(f).then(function () {
                                    app.map.infoWindow.reposition();
                                }),
                                d && app.map.infoWindow.hide();
                            if (p) {
                                var t = app.maps[l].response.itemInfo.itemData.operationalLayers,
                                    n = u.webmap.layers || [];
                                $.each(t, function (e, t) {
                                    var r = t.layerObject || (t.featureCollection ? t.featureCollection.layers[0].layerObject : null),
                                        i = $(n).filter(function (e, t) {
                                            return t.id == r.id;
                                        });
                                    r.setVisibility(i.length ? i[0].visibility : t.visibility);
                                });
                            }
                        } else e.publish("story-perform-action-media", app.data.getCurrentSection().media);
                        $(".mediaBackContainer").hide();
                    }),
                    d ||
                    $(".mediaBackContainer")
                ...
                var m = null;
                if (!a) return;
                o.zoom.mapMarker && ((m = new t()), m.add(new n(new r(o.zoom.center), new s(app.cfg.SECTION_ACTION_ZOOM_MAP_MARKER, 32, 32))), app.map.addLayer(m)),
                    app.map.centerAndZoom(o.zoom.center, o.zoom.level).then(function () {
                        if ($("body").hasClass("layout-float")) {
                            var e = app.map.toScreen(m.graphics[0].geometry),
                                t = null,
                                n = null;
                            $("body").hasClass("layout-float-right")
                                ? ((t = $("#floatingPanel").position().left), e.x >= t && (n = app.map.toMap(new i(app.map.width / 2 + e.x - t / 2, $("#floatingPanel").height() / 2))))
                                : $("body").hasClass("layout-float-left") &&
                                ((t = $("#floatingPanel").position().left + $("#floatingPanel").width()), e.x <= t && (n = app.map.toMap(new i(app.map.width / 2 - e.x + t / 2, $("#floatingPanel").height() / 2)))),
                    ...
                    $(".backButton")
                        .off("click")
                        .click(function () {
                            app.map.setExtent(f), m && app.map.removeLayer(m), $(".mediaBackContainer").hide();
                        });
            }
        }
        var o = !1;
        return { prepareEditorContent: u, createMainMediaActionLink: h, createMediaFullScreenButton: d, performAction: m, styleSectionPanelContent: l, prepareContentIframe: a, loadContentIframe: f };
    }),
    define("storymaps/tpl/ui/mobile/PopupUtils", ["storymaps/common/utils/CommonHelper", "../StoryText"], function (e, t) {
        function n(e) {
            if (!e) return;
            e.is(":visible")
                ? (e.toggleClass("hideContent").slideToggle(), s(e))
                : (i(e),
                    e.slideToggle(400, function () {
                        e.toggleClass("hideContent");
                    }),
                    t.loadContentIframe(e));
        }
        function r(e) {
            e.addClass("hideContent").slideUp(),
                s(e),
                $.each(e.find(".content-container"), function (e, t) {
                    t.scrollTop = 0;
                });
        }
        function i(e) {
            e.siblings(".mobilePopup").hide().addClass("hideContent"), app.ui.mobileFooter.removeMobileInvite();
        }
        function s(e) {
            var t = e.find("iframe[data-unload=true]");
            t.length &&
                setTimeout(function () {
                    t.each(function (e, t) {
                        var n = $(t);
        ...
        return {
            onPopupClick: function (e) {
                var t = $(this),
                    ...
                    i = t.offset().top;
                e.clientX > n - 14 && e.clientY > i - 14 && r(t);
            },
            open: function (e) {
                if (!e) return;
                var n = e.find(".content-container");
                n.length || (n = e.children()),
                    e.is(":visible")
                        ? (n[0].scrollTop = 0)
                        : (i(e),
            ...
            setColors: function (t) {
                $(".mobilePopup").css({ color: t.text, backgroundColor: t.panel }), e.addCSSRule(".mobilePopup ::-webkit-scrollbar-thumb { background-color:" + t.header + "; }", "MobilePopupScrollbar");
            },
        };
    }),
    define("storymaps/tpl/ui/MainStage", [
        ...
        return function (a, f, l) {
            ...
            function b(e, t, n, r) {
                var i = $(".mainMediaContainer.active > iframe[data-unload=true]");
                i.length && i.attr("src", "");
                if (r) {
                    var s = $(".mainMediaContainer.active");
                    s.fadeOut(function () {
                        s.css("display", "");
                    });
                }
                T();
                if (e.type == "webmap") N(e.webmap.id, t, n, e, !1, r);
                else if (e.type == "image") H(e.image, r);
                else if (e.type == "video") B(e.video.url, e.video, r);
                else if (e.type == "webpage") {
                    var o = e.webpage.url;
                    o.lastIndexOf("#") > 0 && (o = o.substring(0, o.lastIndexOf("#"))), B(o || e.webpage.ts, e.webpage, r);
                }
            }
            function x() {
            ...
            function N(e, t, n, r, s, u) {
                console.log("tpl.core.MainStage - updateMainMediaMaps:", e, n, s);
                var a = $('.mapContainer[data-webmapid="' + e + '"]');
                s || ($(".mainMediaContainer").removeClass("active has-error"), a.parent().addClass("active")), a.parent().toggleClass("animate", !!u);
                if (e)
                    if (a.hasClass("map") && !s && !a.hasClass("isLoading")) {
                        var c = app.map ? app.map.extent : null;
                        (app.map = app.maps[e].response.map), (app.mapItem = app.maps[e].response.itemInfo), (app.mapConfig = app.maps[e]), C(app.map, a, t, c, n, r, !1, s);
                    } else if (a.hasClass("map") && !s && a.hasClass("isLoading")) {
                        x();
                        var d = y.subscribe("story-loaded-map", function (t) {
                            t.id == e &&
                    ...
                    } else if (!a.hasClass("map") && !a.hasClass("isLoading")) {
                        s || x(), a.addClass("isLoading");
                        var m = r && r.webmap ? r.webmap.extent : null;
                        if (m)
                            try {
                                m = l.getLayoutExtent(new h(m), !1);
                            } catch (g) {
                                m = null;
                            }
                        l.loadWebmap(e, a[0], m).then(
                            E.hitch(p, function (u) {
                                var c = app.map ? app.map.extent : null;
                                a.removeClass("isLoading"),
                                    (app.maps[e] = l.getMapConfig(u, a)),
                                    s || ((app.map = u.map), (app.mapItem = app.maps[e].response.itemInfo), (app.mapConfig = app.maps[e])),
                                    u.map.infoWindow && ($(u.map.infoWindow.domNode).addClass("light"), (u.map.infoWindow.markerSymbol = new v().setSize(0))),
                                    C(u.map, a, t, c, n, r, !0, s);
                                if (f) {
                                    (app.ignoreNextEvent = !1),
                                        w.before(u.map, "setExtent", function (t) {
                                            console.log("Set extent:", e), app.ignoreNextEvent || ((app.lastExtentSet = t), (app.ignoreNextEvent = !0));
                                        });
                                    var h = u.map.on("update-end", function () {
                                        h.remove(), (app.lastExtentSet = u.map.extent), (u.map.mapJournalInitExtent = u.map.extent), (app.ignoreNextEvent = !0);
                                    }),
                                        p = function (e) {
                                            app.ignoreNextEvent ? (app.ignoreNextEvent = !1) : (app.lastExtentSet = e.extent);
                                        };
                                    u.map.on("zoom-end", p), u.map.on("pan-end", p);
                                }
                                s ||
                                    setTimeout(function () {
                                        T();
                                    }, 50),
                                    u.map.on("extent-change", function () {
                                        app.appCfg.mapsSyncAppOption &&
                                            i.getMapOptions().mapsSync &&
                                            a.parent().hasClass("active") &&
                                            ($.each(Object.keys(app.maps), function (t, n) {
                                                e != n && l.setMapExtent(l.getLayoutExtent(u.map.extent, !0), app.maps[n].response.map);
                                            }),
                                                (app.lastMapExtent = u.map.extent)),
                                            setTimeout(function () {
                                                D(u.map, u.map.infoWindow);
                                            }, 100);
                                    }),
                                    a.siblings(".mobileInfo").find(".content-toggles .btn").click(app.ui.mobileEntryInfo.onPopupContentToggle);
                                var d = new S({}, a.siblings(".mobileInfoWindow").find(".dijitContainer")[0]);
                                d.startup(),
                                    u.map.infoWindow.on("set-features", function () {
                                        var e = $("body").hasClass("mobile-view");
                                        if (e) {
                                            var t = u.map.infoWindow.getSelectedFeature();
                                            d.set("content", t ? t.getContent() : ""), o.open(a.siblings(".mobileInfoWindow"));
                                        }
                                        u.map.infoWindow.set("popupWindow", !e);
                                    }),
                                    w.after(u.map.infoWindow, "show", function () {
                                        D(u.map, u.map.infoWindow);
                                    }),
                                    app.lastMapExtent || (app.lastMapExtent = u.map.extent),
                            ...
                            E.hitch(p, function () {
                                s || T(),
                                    ...
                                    a.parent().find(".error").html(i18n.viewer.errors.mapLoadingFail),
                                    y.publish("story-loaded-map", { id: e, index: n }),
                                    y.publish("ADDEDIT_LOAD_WEBMAP_FAIL");
                            })
                        ),
                            setTimeout(function () {
                                y.publish("story-section-map-timeout");
                            }, 2e3);
                    }
            }
            function C(e, t, n, r, o, u, a, f) {
                p.updateMainStageWithLayoutSettings(), P();
                try {
                    e.resize(), e.reposition();
                } catch (c) { }
                if (n || u) {
                    var d = u && u.webmap ? u.webmap.layers : null,
                        v = app.maps[u.webmap.id].response.itemInfo.itemData.operationalLayers;
                    $.each(v, function (e, t) {
                        var n;
                        if (t.layerObject) {
                            n = $(d).filter(function (e, n) {
                            ...
                            t.featureCollection &&
                                ...
                                $.each(t.featureCollection.layers, function (e, t) {
                                    (n = $(d).filter(function (e, n) {
                    ...
                    var m = u && u.webmap ? u.webmap.extent : null;
                    if (m)
                        try {
                            m = new h(m);
                        } catch (c) { }
                    app.firstMapIsPreloaded && !app.lastMapExtent
                        ? (m = s.getLayoutExtent(m || e._params.extent, !0))
                        : f && a && k(o) && app.lastMapExtent
                            ? (m = s.getLayoutExtent(app.lastMapExtent, !0))
                            : !a && k(o)
                                ? (m = null)
                                : !m && !k(o)
                                    ? ((m = s.getLayoutExtent(e._params.extent, !0)), (m = s.getLayoutExtent(m, !1)))
                                    : !m && k(o) && app.lastMapExtent
                                        ? (m = s.getLayoutExtent(app.lastMapExtent, !0))
                                        : m || ((m = s.getLayoutExtent(e._params.extent, !0)), a && (m = s.getLayoutExtent(m, !1)));
                    var g = function () {
                        y.publish("story-loaded-map", { id: u.webmap.id, index: o });
                    };
                    m
                        ? l.setMapExtent(m, e).then(function () {
                            L(e, u.webmap.popup, o), g();
                        })
                        : g();
                    var b = u.webmap.overview || {},
                        w = u.webmap.legend || {},
                        E = i.getSettings().mapOptions;
                    E && E.overview && E.overview && (b = E.overview),
                        o === null && n.media && n.media.webmap && ((b = n.media.webmap.overview || {}), (w = n.media.webmap.legend || {})),
                        b.enable !== undefined && (app.maps[u.webmap.id].overview.toggle(b.enable, i.getColors()), app.maps[u.webmap.id].overview.toggleExpanded(b.openByDefault), app.maps[u.webmap.id].overview.setSettings(b)),
                        w.enable !== undefined && (app.maps[u.webmap.id].legend.toggle(w.enable), app.maps[u.webmap.id].legend.toggleExpanded(w.openByDefault), app.maps[u.webmap.id].legend.setSettings(w)),
                        m || L(e, u.webmap.popup, o);
                } else y.publish("ADDEDIT_WEBMAP_DONE");
            }
            function k(e) {
                if (app.appCfg.mapsSyncAppOption && i.getMapOptions().mapsSync) {
                    var t = Number.MAX_VALUE;
                    return (
                        $.each(app.data.getWebmapsInfo(), function (e, n) {
                            var r = Math.min.apply(null, n.entries);
                            t = Math.min(t, r);
                        }),
                        e >= t - 1
                    );
            ...
            function L(e, t, n) {
                e.infoWindow && e.infoWindow.hide();
                if (t) {
                    var r = e.getLayer(t.layerId),
                        i = t.layerId ? t.layerId.split("_").slice(0, -1).join("_") : "",
                        s = e.getLayer(i);
                    e.infoWindow.clearFeatures();
                    if (r)
                        if (r.updating)
                            var o = r.on("update-end", function () {
                                o.remove(), A(e, t, n);
                            });
                        else A(e, t, n);
                    else if (s) {
                        var u = t.layerId.split("_").slice(-1).join("_"),
                            a = s.url + "/" + u,
                            f = E.getObject("infoTemplates." + u + ".layerUrl", !1, s);
                        (a = f || a), O(e, t, n, i, u, a);
                    } else
                        var l = app.map.on("update-end", function () {
                            L(e, t, n), l.remove();
                        });
                }
            }
            function A(e, t, n) {
                var r = new m(),
                    i = e.getLayer(t.layerId);
                if (!i) return;
                (r.objectIds = [t.fieldValue]), i._collection || ((r.returnGeometry = !0), (r.outFields = ["*"]), (r.outSpatialReference = e.spatialReference));
                if (!i.queryFeatures) return;
                i.queryFeatures(r).then(function (r) {
                    M(e, t, r.features, n);
                });
            }
            function O(e, t, n, r, i, s) {
                var o = new g(s),
                    ...
                    a = e.getLayer(r);
                if (!a) return;
                (u.objectIds = [t.fieldValue]),
                    (u.returnGeometry = !0),
                    (u.outFields = ["*"]),
                    (u.outSpatialReference = e.spatialReference),
                    o.execute(u, function (s) {
                        M(e, t, s.features, n, r, i);
                    });
            }
            function M(e, t, n, r, i, s) {
                ...
                var o = n[0].geometry,
                    u = null;
                t.anchorPoint ? (u = new c(t.anchorPoint)) : (u = o.getExtent() ? o.getExtent().getCenter() : o),
                    i ? ((n[0].infoTemplate = e.getLayer(i).infoTemplates[s].infoTemplate), e.infoWindow.setContent(n[0].getContent())) : e.infoWindow.setFeatures(n),
                    e.infoWindow.show(u),
                    e.extent.contains(u) ||
                    (e.centerAt(u),
                        r === null &&
            ...
            function D(e, t) {
                if (!e || !t || !t.getSelectedFeature() || !t.location) return;
                var n = $(e.container),
                    r = n.width(),
                    i = n.height(),
                    s = e.toScreen(e.infoWindow.location),
                    o = n.find(".esriSimpleSlider:visible, .geocoderBtn:visible"),
                    u = o.last().position() || { left: 0 },
                    a = $(".descLegendPanel:visible").position(),
                    f = 300;
                $(".esriPopup").removeClass("app-hidden"),
                    a && a.left && (r = a.left),
                    o.length == 1 && (u.top += 60),
                    s.x < f + u.left && s.y < i / 3
                        ? t.set("anchor", "bottom-right")
                        : s.x < r - f && s.y < i / 3
                            ? t.set("anchor", "bottom")
                            : s.x >= r - f && s.y < i / 3
                                ? t.set("anchor", "bottom-left")
                                : s.x < r - f && s.y < (i * 2) / 3
                                    ? t.set("anchor", "right")
                                    : s.x >= r - f && s.y < (i * 2) / 3
                                        ? t.set("anchor", "left")
                                        : s.x < f + u.left && s.y >= (i * 2) / 3
                                            ? t.set("anchor", "top-right")
                                            : s.x < r - f && s.y >= (i * 2) / 3
                                                ? t.set("anchor", "top")
                                                : t.set("anchor", "top-left"),
                    s.x < u.left + 30 && s.y < u.top + 30 && $(".esriPopup").addClass("app-hidden"),
                    a && s.y < $(".descLegendPanel:visible").height() + 20 && (a.left === 0 ? s.x < $(".descLegendPanel:visible").width() && $(".esriPopup").addClass("app-hidden") : s.x > a.left && $(".esriPopup").addClass("app-hidden")),
                    (s.x <= 0 || s.y <= 10 || s.x >= r || s.y >= i) && $(".esriPopup").addClass("app-hidden");
            }
            function P() {
                if (app.mapConfig) {
                    var e = app.data.getWebAppData().getColors();
                    app.mapConfig.overview.setColors(e), app.mapConfig.legend.setColors(e);
                }
            }
            function H(e, t) {
                $(".mainMediaContainer").removeClass("active");
                var n = $('.imgContainer[data-src="' + e.url + '"]');
                if (n.length) {
                    n.css("background-image") == "none" && x();
                    var r = e.url;
                    if (e.sizes) {
                        var i = _.sortBy(e.sizes, "width").reverse();
                        r = i[0].url;
                        if (i.length > 1) {
                            var s = e.display && e.display === "fit" ? $("#mainStagePanel").width() : $("body").width();
                            _.some(i, function (e) {
                                return e.width && e.width < s ? !0 : ((r = e.url), !1);
                            });
                        }
                    }
                    var o = u.possiblyAddToken(r);
                    console.log('o', o)
                    n.parent().addClass("active").toggleClass("animate", !!t);
                    var a = new Image();
                    (a.src = o),
                        (a.onload = function () {
                            n
                                ...
                                p.updateMainStageWithLayoutSettings(),
                                n.parent().hasClass("active") && setTimeout(T(), 100);
                        });
                }
            }
            function B(e, t, n) {
                ...
                $(".mainMediaContainer").removeClass("active");
                var s = $('.embedContainer[data-src="' + r + '"]');
                if (!s.length) {
                    s = $('.embedContainer[data-ts="' + e + '"]');
                    try {
                        r = btoa(s.data("src"));
                    } catch (i) {
                        r = s.data("src");
                ...
                if (s.length) {
                    s
                        .removeClass("center fit fill stretch")
                        .addClass(t.display)
                        .attr("data-unload", t.hash === undefined && (t.unload === undefined || t.unload))
                        .css({ left: 0, right: 0 }),
                        r.match("//") || (r = atob(r)),
                        t.hash && ((r = r + "#" + t.hash), s.attr("src", r)),
                        s.attr("src") || (s.off("load").load(T), x(), r.match("//player.vimeo.com/video") && !r.match("transparent=0") && (r.match(/\?/) ? (r += "&transparent=0") : (r += "?transparent=0")), s.attr("src", r));
                    var o = t.width || "560",
                        u = t.height || "315";
                    t.display == "fit" && ((o = ""), (u = "")),
                        o && (o.match(/[0-9]+%/) || (o += "px"), s.attr("width", o)),
                        u && (u.match(/[0-9]+%/) || (u += "px"), s.attr("height", u)),
                        s.parent().addClass("active").toggleClass("animate", !!n),
                        p.updateMainStageWithLayoutSettings();
                }
            }
            function j() {
            ...
            (this.updateMainMediaContainers = function () {
                ...
                $.each(r, function (t, n) {
                    ...
                    $(".mapContainer").each(function () {
                        var e = $(this).data("webmapid");
                        $.inArray(e, r) == -1 && ($(this).parent().remove(), app.maps[e] && (app.maps[e].response.map.destroy(), delete app.maps[e]));
                    }),
                    $.each(i, function (e, n) {
                        var r = $('.imgContainer[data-src="' + n + '"]');
                        r.length || $("#mainStagePanel .medias").append(t({ url: n }));
                    }),
                    ...
                    $.each(s, function (e, t) {
                        ...
                        var o = $('.embedContainer[data-src="' + r + '"]');
                        o.length || (o = $('.embedContainer[data-ts="' + t.ts + '"]'));
                        if (!o.length) {
                            $("#mainStagePanel .medias").append(n({ url: r, frameTag: t.frameTag, unload: t.unload === undefined || !!t.unload }));
                            if (!!t.frameTag) {
                                var u = $("#mainStagePanel .medias .mainMediaContainer").last().find("iframe").first();
                                u.addClass("embedContainer")
                                    .attr("data-src", u.attr("src"))
                                    .removeAttr("src")
                                    .attr("data-ts", t.ts)
                                    .attr("data-unload", t.unload === undefined || !!t.unload);
                            }
                        }
                    }),
                    $(".embedContainer").each(function () {
                        var e = $(this).data("ts");
                        e || ((e = $(this).data("src")), e.match("//") || (e = atob(e)));
                        var t =
                            $.grep(s, function (t) {
                                var n = t.url;
                    ...
                    P(),
                    $(".mainMediaContainer").find(".mobilePopup").off("click").click(o.onPopupClick);
            }),
                (this.updateMainMediaWithStoryMainMedia = function (e, t) {
                    var n = app.data.getStoryByIndex(e);
                    n && n.media && b(n.media, n, e, t), y.publish("story-load-entry", e);
                }),
                (this.updateMainMediaWithStoryAction = function (e) {
                    b(e, app.data.getCurrentSection(), null, !0);
                }),
                (this.updateMainStageWithLayoutSettings = function () {
                    var e = i.getLayoutId(),
                        ...
                        o = 0,
                        u = null;
                    j(), a.css("background-color", t.media), P();
                    if (e == "tab" || e == "bullet") {
                        (o = $("#descLegendPanel:visible").width() || 0), (u = $("#descLegendPanel:visible").position() || {});
                        var f = $(".mainMediaContainer.active .overviewContainer:visible").css("right"),
                            l = 191;
                        if (e == "tab" || e == "bullet")
                            o
                                ? r
                                    ? $(".mainMediaContainer.active .esriControlsBR").css({ left: "", right: f ? l + 10 : "" })
                                    : ($(".mainMediaContainer.active .esriControlsBR").css({ left: f ? l + 10 : "", right: "initial" }),
                                        $(".mainMediaContainer.active .esriAttribution").css("float", "inherit"),
                                        setTimeout(function () {
                                            $(".mainMediaContainer.active .esriAttribution").css("float", "");
                                        }, 0))
                                : $(".mainMediaContainer.active .esriControlsBR").css({ left: "", right: "" });
                        $(".mapConfigOverlay.position, .mapConfigOverlay.popup, #mainStageLoadingIndicator, .mainStageErrorContainer").css("left", r ? (o + s) / 2 : (s - o) / 2),
                            $("body").hasClass("mobile-view") && $("#mainStageLoadingIndicator, .mainStageErrorContainer").css("left", "50%");
                        var c = r ? "padding-left" : "padding-right",
                            h = r ? "left" : "right",
                            p = u.left;
                        r ? (p += o) : (p = s - u.left),
                            $(".centerAlignOnFloat").css({ paddingRight: 0, paddingLeft: 0 }).css(c, p),
                            s <= 1067 && $("#builderHelp").css(c, 0),
                            $(".mainMediaContainer .imgContainer.center").css({ left: 0, right: 0 }).css(h, p),
                            $(".mainMediaContainer .embedContainer.center").css({ left: 0, right: 0 }).css(h, p),
                            $(".mainMediaContainer .embedContainer.custom").css({ left: 0, right: 0 }).css(h, p);
                        if (!o) $("#autoplay").css({ left: "50%", right: "inherit" });
                        else {
                            var d = r ? s - (u.left + o) : u.left,
                                v = $("#descLegendPanel:visible").height(),
                                m = $("#contentPanel").height();
                            v <= m / 2
                ...
                (this.preloadAllMaps = function (e) {
                    var t = app.data.getStoryEntries(),
                        n = t[0],
                        r = t.slice(1),
                        i = 0;
                    if (!n) return;
                    if (n.media && n.media.type == "webmap")
                        $.each(r, function (t, n) {
                            n.media && n.media.type == "webmap" && (e || i < 4) && (N(n.media.webmap.id, n, t + 1, n.media, !0, !1), i++);
                        });
                    else {
                        var s = -1;
                        $.each(r, function (t, n) {
                            if (s != -1) return;
                            if (n.media && n.media.type == "webmap") {
                                (s = t + 1), (app.firstMapIsPreloaded = !0), N(n.media.webmap.id, n, s, n.media, !0, !1);
                                var o = y.subscribe("story-loaded-map", function () {
                                    o.remove(),
                                        $.each(r.slice(s), function (t, n) {
                                            n.media && n.media.type == "webmap" && (e || i < 4) && (N(n.media.webmap.id, n, t + s + 1, n.media, !0, !1), i++);
                                        });
                                });
                            }
                        });
                ...
                (this.reloadCurrentWebmap = function () {
                    var t = app.data.getCurrentEntry();
                    if (t && t.media && t.media.webmap) {
                        ...
                        r.parent().remove(),
                            ...
                            y.publish("story-navigate-entry", app.data.getCurrentEntryIndex());
                    }
                }),
                (this.loadTmpWebmap = function (e) {
                    $('.mapContainer[data-webmapid="' + e + '"]').length || d(e), N(e, null, null, null);
                });
        };
    }),
    define("storymaps/tpl/core/Config", [], function () {
        ...
        return (
            (app.appCfg = {
                ...
                headerCompactOpt: !0,
                headerCompactByDefault: !0,
                mapsSyncAppOption: !0,
                mapsUseTermSection: !1,
                mapsImmediateResize: !0,
                mapCommandLargerTouch: !1,
                mediaPickerDisableVideo: !1,
                mediaPickerDisableWebPage: !1,
                mediaPickerSkipConfigure: !1,
                mediaPickerConfigureForceMode: null,
            }),
            (app.appCfg.getLayoutThumbnail = function (e) {
                e = e || {};
                var t = e.layout || n.id,
                    n = app.data.getLayoutStaticConfig(t),
                    r = e.theme || n.themes[0],
                    i = e.options || { panel: { position: n.positions[0], size: "medium" } },
                    s = e.selected || !1,
                    o = e.contentLabel || !1,
                    u = "",
                    a = "",
                    ...
                    l = "",
                    c = 15;
                t == "bullet" ? (c = 18) : t == "tab" && (c = 21),
                    (u += '<div class="layout-thumbnail' + (s ? " selected" : "") + "\" data-colors='" + JSON.stringify(r) + "'>"),
                    (u += '<div class="layout-selected"></div>'),
                    (u += '<div class="layout-header" style="height: $size$%; background-color:$color$; $styleOpt$"><span class="thumb-content $contentClass$" style="$contentStyle$">$content$</span></div>'),
                    (u = u.replace("$size$", c).replace("$color$", r.header).replace("$styleOpt$", ""));
                if (t != "accordion") {
                    var h = "header-tabs",
                        p = "header-tab",
                        d = "";
                    t == "bullet" && ((h = "header-bullets"), (p = "header-bullet"));
                    for (var v = 1; v <= 3; v++) {
                        var m = "background-color: " + r.tab + "; color:" + r.tabText + ";";
                        v == 1 && (m = "background-color: " + r.tabActive + "; color:" + r.tabTextActive + ";"),
                            (d += '<span class="' + p + '" style="' + m + '">'),
                            t == "tab" ? (d += "Tab " + v) : i.reverse ? (d += 3 - v + 1) : (d += v),
                            (d += "</span>");
                    }
                    u = u.replace("$contentClass$", h).replace("$content$", d);
                }
                a = '<div class="layout-block" style="width: $size$%; height: $height$%; background-color:$color$; $styleOpt$"><span class="thumb-content $contentClass$" style="$contentStyle$">$content$</span></div>';
                var g = 0,
                    y = 0,
                    b = 100 - c - 1,
                    w = "",
                    ...
                    S = "";
                t == "accordion"
                    ? (i.panel.size == "small" ? ((g = 23), (y = 71)) : i.panel.size == "large" ? ((g = 43), (y = 51)) : ((g = 28), (y = 66)),
                        (w = "float: left;"),
                        i.panel.position == "left" ? (E += "margin-left: 3%;") : (S += "margin-left: 3%;"))
                    : ((y = 94),
                        (E = "position: absolute; top: calc(" + c + "% + 4px); z-index:1; height: 35% !important; opacity: 0.8;"),
                        (S += "margin-left: 3%;"),
                        i.panel && (i.panel.position == "left" ? (E += "left: 3%") : (E += "right: 3%"), i.panel.size == "small" ? (g = 23) : i.panel.size == "large" ? (g = 43) : (g = 28))),
                    (f = a
                        .replace("$size$", g)
                        .replace("$height$", b)
                        .replace("$color$", r.panel)
                        .replace("$styleOpt$", w + E)),
                    (l = a
                        .replace("$size$", y)
                        .replace("$height$", b)
                        .replace("$color$", r.media)
                        .replace("$styleOpt$", w + S)),
                    o &&
                    t == "accordion" &&
                    (f = f
                        .replace("$contentClass$", "panel-lbl rotate")
                        .replace("$contentStyle$", "color: " + r.text)
                        .replace("$content$", n.title)),
                    i.panel ? (i.panel.position == "left" ? (u += f + l) : (u += l + f)) : (u += l),
                    (u = u
                        .replace(/\$contentStyle\$/g, "")
                        .replace(/\$contentClass\$/g, "")
                        .replace(/\$content\$/g, ""));
                if (!o && r && r.name && r.name.match) {
                    var x;
                    r.name.match(/-org$|-modified$/) &&
                        (r.name.match(/-modified$/) ? (x = i18n.builder.settingsThemeOptions.lblModTheme) : (x = i18n.builder.settingsThemeOptions.lblOrgTheme), (u += '<div class="theme-label">' + x + "</div>"));
                }
                return (u += "</div>"), u;
            }),
            {
                checkConfigFileIsOK: function () {
                    return (
                        (app.cfg.HEADER_LOGO_URL = e),
                        (app.cfg.HEADER_LOGO_TARGET = t),
                        (app.cfg.HEADER_LINK_TEXT = i18n.viewer.headerFromCommon.storymapsText),
                        (app.cfg.HEADER_LINK_URL = n),
                        app.cfg &&
    ...
    define("storymaps/tpl/core/Data", ["./WebApplicationData", "storymaps/common/utils/CommonHelper", "dojo/topic", "esri/arcgis/utils"], function (e, t, n, r) {
        return function () {
            function c(e) {
                r.getItem(e).then(function (t) {
                    (u[e] = { title: t.item.title, sharing: t.item.access.toUpperCase() }), n.publish("LOADED_WEBMAP_INFOS", { id: e, title: t.item.title, sharing: t.item.access.toUpperCase() });
                });
            }
            var s = null,
                o = null,
            ...
            (this.getWebMap = function () {
                ...
                (this.userIsAppOwner = function () {
                    ...
                    return (
                        ...
                        (t.getPortalUser() != null && t.getPortalUser() == this.getWebAppItem().owner) ||
                        (e && e.privileges && $.inArray("portal:admin:updateItems", e.privileges) > -1) ||
            ...
            (this.getStoryStorage = function () {
                ...
                (this.getStory = function () {
                    return f == "WEBAPP" ? e.getStory() || {} : {};
                }),
                (this.getStoryEntries = function () {
                    var t = [],
                        n = [];
                    return (
                        f == "WEBAPP" && (t = e.getStoryEntries()),
                        (t = t.slice(0, app.cfg.MAX_NB_ENTRIES)),
                        app.isInBuilder
                            ? t || []
                            : ($.each(t || [], function (e, t) {
                                t.status == "PUBLISHED" && n.push(t);
                            }),
                                n)
                    );
                }),
                (this.cleanEntriesMarkup = function () {
                    $.each(
                        this.getStoryEntries(),
                        function (e, t) {
                            this.cleanEntryMarkup(t);
                        }.bind(this)
                    );
                }),
                (this.cleanEntryMarkup = function (e) {
                    var n = e.description;
                    if (!n) return;
                    var r = $("<div>" + n + "</div>");
                    r.find("img").each(function (e, n) {
                        var r = $(n);
                        r.attr("src", t.possiblyAddToken(r.attr("src")));
                    }),
                        (e.description = r.html());
                }),
                (this.getStoryLength = function () {
                    return this.getStoryEntries().length;
                }),
                (this.getStoryByIndex = function (e) {
                    return this.getStoryEntries()[e];
                }),
                (this.getCurrentSection = function () {
                    return this.getStoryByIndex(l);
                }),
                ...
                (this.addStorySection = function (t) {
                    e.setStoryEntries(this.getStoryEntries().concat(t)), this.setCurrentSectionIndex(this.getStoryLength() - 1);
                }),
                (this.editSection = function (t, n) {
                    var r = this.getStoryEntries();
                    (r[t] = n), e.setStoryEntries(r);
                }),
                (this.organizeStory = function (t, n) {
                    e.setStoryEntries(t), n == -1 && (n = 0), this.setCurrentSectionIndex(n);
                }),
                ...
                (this.getWebmapsInfo = function () {
                    var t = [],
                        n = {},
                        r = function (e, t, r) {
                            n[e] ? n[e][t].indexOf(r) == -1 && n[e][t].push(r) : ((n[e] = { entries: [], actions: [] }), n[e][t].push(r));
                        };
                    $.each(this.getStoryEntries(), function (e, t) {
                        t.media && t.media.type == "webmap" && t.media.webmap && r(t.media.webmap.id, "entries", e + 1),
                            t.contentActions &&
                            $.each(t.contentActions, function (t, n) {
                    ...
                    return (
                        $.each(Object.keys(n), function (e, r) {
                            var i = u[r];
                            if (!i) {
                                if (app.maps[r]) {
                                    (u[r] = { title: app.maps[r].response.itemInfo.item.title, sharing: app.maps[r].response.itemInfo.item.access.toUpperCase() }),
                                        t.push({ id: r, title: app.maps[r].response.itemInfo.item.title, sharing: app.maps[r].response.itemInfo.item.access.toUpperCase(), entries: n[r].entries });
                                    return;
                                }
                                c(r);
                            }
                            t.push({ id: r, title: i ? i.title : null, sharing: i ? i.sharing : null, entries: n[r].entries });
                        }),
                        t
                    );
                }),
                (this.getWebmapTitle = function (e) {
                    return u[e] ? u[e].title : "";
                }),
                (this.getWebmapSharing = function (e) {
                    return u[e] ? u[e].sharing : "";
                }),
                ...
                (this.debug = function () {
                    console.table && console.table(app.data.getStoryEntries()),
                        $.each(app.data.getStoryEntries(), function (e, t) {
    ...
    define("lib-build/tpl!storymaps/tpl/ui/desktop/AccordionPanelEntry", [], function () {
        return function (obj) {
            function print() {
                __p += __j.call(arguments, "");
            }
    ...
    define("lib-build/css!storymaps/tpl/ui/desktop/AccordionPanel", [], function () { }),
    define("lib-build/css!storymaps/tpl/ui/desktop/Common", [], function () { }),
    define("storymaps/tpl/ui/desktop/AccordionPanel", ["lib-build/tpl!./AccordionPanelEntry", "lib-build/css!./AccordionPanel", "lib-build/css!./Common", "../StoryText", "storymaps/common/utils/CommonHelper", "dojo/topic"], function (
        e,
        t,
        n,
        r,
        ...
        return function (n, o, u) {
            function c(t, i) {
                var o = t.length,
                    u = "";
                $.each(t, function (t, n) {
                    var r = i.reverse ? o - t : t + 1;
                    u += e({
                        index: r,
                        title: n.title,
                        description: n.description,
                        optHtmlClass: n["status"] != "PUBLISHED" ? "hidden-entry" : "",
                        isInBuilder: app.isInBuilder,
                        editorPlaceholder: app.isInBuilder ? i18n.builder.textEditor.placeholder1 : "",
                    });
                }),
                    app.isInBuilder ? n.find(".content").html(u) : n.find(".content").html(r.prepareContentIframe(r.prepareEditorContent(u))),
                    n.find(".accordion-header").click(m);
                var a = n.find(".accordion-header-content");
                a.focus(function () {
                ...
                var f = a.last();
                f.siblings(".accordion-content").find("[tabindex=0]").length && (f = f.siblings(".accordion-content").find("[tabindex=0]").last()),
                    f.on("keydown", function (e) {
                        if (e.keyCode === 9 && !e.shiftKey) return s.publish("story-tab-navigation", { from: "panel", direction: "forward" }), !1;
                    });
            }
            function h(e) {
                n.css("width", e.panel.sizeVal), n.toggleClass("is-numbered", !!e.numbering);
            }
            function p() {
                var e = n.outerHeight(),
                    t = 0;
                n.find(".accordion-header").each(function () {
                    t += $(this).outerHeight() + 1;
                }),
                    o && (t += n.find(".builder-content-panel").outerHeight()),
                    e - t < 120
                        ? n
                            .find(".accordion-content")
                            .css("height", "")
                            .css("max-height", e / 1.5)
                        : n
                            .find(".accordion-content")
                            .css("height", e - t)
                            .css("max-height", ""),
                    o && n.find(".content").css("height", n.height() - n.find(".builder-content-panel").outerHeight());
            }
            function d(e) {
                var t = e.find("iframe[data-unload=true]");
                t.length &&
            ...
            function v(e) {
                n.css({ color: e.text, backgroundColor: e.panel }),
                    i.addCSSRule(
                        ".accordionPanel .accordion-header-arrow { border-left-color: " +
                        e.accordionArrow +
                        "; }" +
                        ".accordionPanel .entry.active .accordion-header-arrow { border-left-color: " +
                        e.accordionArrowActive +
                        "; }" +
                        ".accordionPanel .entry:not(.active) .accordion-header:hover .accordion-header-arrow { border-left-color: " +
                        e.accordionArrowHover +
                        "; }" +
                        ".accordionPanel .entry { border-top: 1px solid " +
                        e.accordionArrow +
                        "; }",
                        "AccordionColorArrow"
                    ),
                    i.addCSSRule(".accordionPanel .accordion-header-number { color: " + e.accordionNumber + "; }", "AccordionColorNumber"),
                    i.addCSSRule(".accordionPanel .accordion-header-title { color: " + e.accordionTitle + "; }", "AccordionColorTitle"),
                    i.addCSSRule(".accordionPanel ::-webkit-scrollbar-thumb { background-color:" + e.header + "; }", "AccordionScrollbar");
            }
            function m(e) {
                $(e.target).hasClass("panelEditBtnInner") ? app.builder.openEditPopup({ entryIndex: a.getEntryIndex() }) : u($(this).parents(".entry").index());
            }
            function g() { }
            function y() { }
            var a = this,
                ...
                l = null;
            o &&
                require(["storymaps/tpl/builder/InlineEditor"], function (e) {
                    l = new e();
                }),
                (this.init = function (e, t, n, r) {
                    (f = null), h(n), v(r), y(), o && g(), c(e, n), this.showEntryIndex(t, !1, !0);
                }),
                ...
                (this.showEntryIndex = function (e, t, i) {
                    if (f != e || t) {
                        d(n.find(".entry.active")), r.loadContentIframe(n.find(".entry").eq(e));
                        var s = n.find(".entry.active"),
                            u = n.find(".entry").eq(e);
                        s.removeClass("active"),
                            i ? s.hide() : s.find(".accordion-content").slideUp(),
                            u.addClass("active"),
                            i ? u.find(".accordion-content").show() : u.find(".accordion-content").slideDown(),
                            o && (n.find(".entry.active .cke_editor_descriptionEditor").length || l.init(n.find(".entry.active"))),
                            (f = e);
                    }
                }),
    ...
    define("lib-build/tpl!storymaps/tpl/ui/desktop/NavBarEntry", [], function () {
        return function (obj) {
            ...
            var __t,
                ...
                __e = _.escape;
            with (obj)
            __p += '<li class="entry ' + ((__t = optHtmlClass) == null ? "" : __t) + '" data-title="' + ((__t = tooltip) == null ? "" : __t) + '">\n	<a class="entryLbl" tabindex="0">' + ((__t = value) == null ? "" : __t) + "</a>\n</li>";
            return __p;
        };
    }),
    ...
    define("storymaps/tpl/ui/desktop/NavBar", [
        ...
        return function (a, f, l) {
            function d(e, t, i) {
                ...
                $.each(h, function (r, i) {
                    var o = i.title;
                    e == "bullet" && (o = t.reverse ? s - r : r + 1),
                        o || (o = f ? '<span style="color: red;">' + i18n.commonCore.inlineFieldEdit.editMe + "</span>" : "&nbsp;"),
                        e == "bullet" && (o += '<div style="height:0; width: 0; overflow: hidden;"><div>;</div><div>' + i.title + "</div></div>"),
                        (l += n({ value: o, tooltip: e == "bullet" ? i.title : "", optHtmlClass: i.status != "PUBLISHED" ? "hidden-entry" : "" }));
                }),
                    a.find(".nav-tabs").html(l + r({ entries: l })),
                    e == "bullet" && !u("touch") && (a.find(".nav-tabs > .entry").tooltip({ placement: "top", trigger: "hover" }), a.find(".dropdown-menu > .entry").tooltip({ placement: "left", container: ".nav-bar", trigger: "hover" })),
                    a.find(".entry").click(g),
                    a.find(".entryLbl").on("keydown", function (e) {
                        if (e.keyCode === 9) return o.publish("story-tab-navigation", { from: "nav", direction: e.shiftKey ? "backward" : "forward" }), !1;
                    }),
                    a
                        .find(".entryLbl")
                        .eq(0)
            ...
            function v(e) {
                a.find(".nav-bar")
                    .toggleClass("isTab", e == "tab")
                    .toggleClass("isBullet", e == "bullet");
            }
            function m(e) {
                a.css("background-color", e.header),
                    i.addCSSRule(".nav-bar .nav > .entry .entryLbl, 					.nav-bar .dropdown-toggle { 						color: " + e.tabText + "; 						background-color: " + e.tab + " !important; 					}", "NavBarTab"),
                    i.addCSSRule(".nav-bar .entry.active > .entryLbl, 					.nav-bar .dropdown.active .dropdown-toggle { 						color: " + e.tabTextActive + "; 						background-color: " + e.tabActive + " !important; 					}", "NavBarActive"),
                    i.addCSSRule(".nav-bar .dropdown:not(.active):hover .dropdown-toggle, 					.nav-bar li:not(.active) .entryLbl:hover { 						color: " + e.tabTextHover + "; 						background-color: " + e.tabHover + " !important; 					}", "NavBarHover");
                if (e.name && e.name.match(/-org$|-modified$/)) {
                    var t = new s(e.tab);
                    (t.a = 0.55),
                        i.addCSSRule(".nav-bar .dropdown-menu, 						.nav-bar .dropdown-menu .entryLbl { 							color: " + e.tabText + " !important; 							background-color: " + t.toString() + " !important; 						}", "NavBarMore"),
                        (t.a = 0.75),
                        i.addCSSRule(".nav-bar .dropdown-menu li:not(.active) .entryLbl:hover { 							background-color: " + t.toString() + " !important; 						}", "NavBarEvenMore");
                } else i.addCSSRule(".nav-bar .dropdown-menu, 						.nav-bar .dropdown-menu .entryLbl { 							color: " + e.tabText + " !important; 							background-color: " + e.header + " !important; 						}", "NavBarMore"), i.addCSSRule("", "NavBarEvenMore");
                i.addCSSRule(
                    ".nav-bar .nav-tabs > .tooltip .tooltip-arrow, 					.nav-bar .builder-content-panel .tooltip-arrow { 						border-top-color: " +
                    e.tabActive +
                    "; 					} 					.nav-bar > .tooltip .tooltip-arrow { 						border-left-color: " +
                    e.tabActive +
                    "; 					} 					.nav-bar .tooltip-inner { 						background-color: " +
                    e.tabActive +
                    "; 						color: " +
                    e.tabTextActive +
                    "; 					}",
            ...
            function y() {
                a.find(".builder-content-panel").css("display", "inline-block"), a.find(".builder-edit").off("click").click(b).find(".builder-lbl").html(i18n.builder.addEditPopup.lblEdit);
            }
            function b() {
                app.builder.openEditPopup({ entryIndex: c.getEntryIndex() });
            }
            function w() { }
            var c = this,
                h = null,
            ...
            a.html(e({})),
                (this.init = function (e, t, n, r, i) {
                    (h = e), (p = null), d(n, r, i), this.showEntryIndex(t), w(), f && y();
                }),
                (this.update = function (e, t, n) {
                    d(e, t, n), this.showEntryIndex(p);
                }),
                (this.resize = function () {
                    a.find(".nav-tabs > li").addClass("visible"), a.find(".nav-tabs .dropdown").removeClass("visible"), a.find(".nav-tabs .dropdown-menu li").removeClass("visible");
                    var e = 0,
                        t = 0,
                        n = !1,
                        r = a.find(".nav-tabs > li:not(.dropdown)"),
                        i = a.find("li.dropdown").outerWidth(),
                        s = a.width() - a.find(".builder-content-panel:visible").outerWidth() - 30 - 4;
                    r.each(function () {
                        t++, (e += $(this).outerWidth());
                        if (e > s || (e + i > s && t < r.length)) (n = !0), $(this).removeClass("visible"), a.find(".nav-tabs .dropdown-menu li").eq($(this).index()).addClass("visible");
                    });
                    var o = a.find(".nav-tabs > .entry.active"),
                        u = a.find(".nav-tabs .dropdown-menu li.active");
                    o.length && !o.hasClass("visible")
                        ? (o.removeClass("active"), a.find(".nav-tabs .dropdown-menu li").eq(o.index()).addClass("active"), a.find(".nav-tabs > .dropdown").addClass("active"))
                        : u.length && !u.hasClass("visible") && (u.removeClass("active"), a.find(".nav-tabs > .entry").eq(u.index()).addClass("active"), a.find(".nav-tabs > .dropdown").removeClass("active")),
                        n && a.find(".nav-tabs .dropdown").addClass("visible");
                }),
                (this.showEntryIndex = function (e) {
                    var t = a.find(".nav-tabs > .entry.visible").length;
                    a.find("li").removeClass("active"),
                        e < t
                            ? (a.find(".entry").eq(e).addClass("active"), app.isLoading || (a.find(".entry").eq(e).find(".entryLbl").focus(), a.find(".dropdown").hasClass("open") && a.find(".dropdown-toggle").click()))
                            : (a.find(".dropdown").addClass("active"),
                                a.find(".dropdown .entry").eq(e).addClass("active"),
                                app.isLoading || (a.find(".dropdown").hasClass("open") || a.find(".dropdown-toggle").click(), a.find(".dropdown .entry").eq(e).focus())),
                        (p = e);
                }),
                (this.getEntryIndex = function () {
                    return p;
    ...
    define("lib-build/tpl!storymaps/tpl/ui/desktop/DescriptionAndLegendPanelEntry", [], function () {
        return function (obj) {
            function print() {
                __p += __j.call(arguments, "");
            }
            ...
            var __t,
                ...
                __j = Array.prototype.join;
            with (obj)
            (__p += '<div class="entry ' + ((__t = optHtmlClass) == null ? "" : __t) + '">\n	<div class="entry-inner">\n		'),
                isInBuilder
                    ? (__p += '\n			<textarea name="descriptionEditor" class="descriptionEditor" placeholder="' + ((__t = editorPlaceholder) == null ? "" : __t) + '">\n				' + ((__t = description) == null ? "" : __t) + "\n			</textarea>\n		")
                    : (__p += '\n			<div class="description">\n				' + ((__t = description) == null ? "" : __t) + "\n			</div>\n		"),
                (__p += "\n	</div>\n</div>");
    ...
    define("lib-build/css!storymaps/tpl/ui/desktop/DescriptionAndLegendPanel", [], function () { }),
    define("storymaps/tpl/ui/desktop/DescriptionAndLegendPanel", [
        "lib-build/tpl!./DescriptionAndLegendPanelEntry",
        ...
        return function (n, r) {
            function c() {
                ...
                $.each(u, function (r, i) {
                    (t += e({
                        isInBuilder: app.isInBuilder,
                        optHtmlClass: i["status"] != "PUBLISHED" ? "hidden-entry" : "",
                        description: i.description || "",
                        editorPlaceholder: app.isInBuilder ? i18n.builder.textEditor.placeholder1 + " " + i18n.builder.textEditor.placeholder2 : "",
                    })),
                        i.media.type == "webmap" && (n.find(".legendWrapper[data-webmap=" + i.media.webmap.id + "]").length || n.find(".legends").append('<div class="legendWrapper" data-webmap="' + i.media.webmap.id + '"></div>'));
                }),
                    app.isInBuilder ? n.find(".descriptions").html(t) : n.find(".descriptions").html(i.prepareContentIframe(i.prepareEditorContent(t)));
            }
            function h(e) {
                var t = !app.isInitializing && (e.description || (e.legend && f.legend == "panel"));
                n.toggle(t), n.find(".descriptions").toggle(f.description), n.css("width", f.panel.sizeVal), n.removeClass("bullet-embed");
                if ($("body").hasClass("layout-bullet")) {
                    var r = app.data.getCurrentEntry();
                    r && r.media && (r.media.type == "video" || r.media.type == "webpage") && n.addClass("bullet-embed");
                }
            }
            function p(e) {
                var t = e.find("iframe[data-unload=true]");
            ...
            function d(e) {
                n.css({ color: e.text }),
                    n.find(".backdrop").css({ backgroundColor: e.panel }),
                    s.addCSSRule(".descLegendPanel::-webkit-scrollbar-thumb { background-color:" + e.header + "; }" + ".descLegendPanel::-webkit-scrollbar-track { background-color:" + e.panel + "; }", "DescLegendPanelScrollbar");
            }
            function v() { }
            var u = null,
                a = null,
            ...
            r &&
                ...
                (this.init = function (e, t, i, s, f) {
                    (u = e),
                        (a = null),
                        c(),
                        this.update(i, s, f),
                        this.showEntryIndex(t, !1, f),
                        n.on("keydown", function (e) {
                            if (e.keyCode === 9) {
                                var t = $(":focus");
                                if (t) {
                                    var n = e.shiftKey ? t.prevAll("*[tabindex=0]") : t.nextAll("*[tabindex=0]");
                                    if (!n.length) return o.publish("story-tab-navigation", { from: "panel", direction: e.shiftKey ? "backward" : "forward" }), !1;
                                }
                            }
                        }),
                        r && v();
                ...
                (this.resize = function (e) {
                    var t = e ? e.height : n.parent().outerHeight();
                    n.toggleClass("no-radius", n.outerHeight() >= t);
                }),
                (this.showEntryIndex = function (e, t, s) {
                    if (a != e || t) {
                        p(n.find(".entry.active")),
                            i.loadContentIframe(n.find(".entry").eq(e)),
                            n.find(".entry").removeClass("active"),
                            n.find(".entry").eq(e).addClass("active"),
                            r && (n.find(".entry.active .cke_editor_descriptionEditor").length || l.init(n.find(".entry.active"))),
                            n.find(".legendWrapper").removeClass("active");
                        if (s.legend) {
                            var o = u[e].media[u[e].media.type].id;
                            n.find(".legendWrapper[data-webmap=" + o + "]").addClass("active");
                        }
                        (a = e),
                            h(s),
                            n.toggleClass("hasDescription", !!f.description && !!s.description),
                            n.toggleClass("hasLegend", !!s.legend && f.legend == "panel"),
                            this.resize(),
                            setTimeout(function () {
                                n[0].scrollTop = 0;
                            }, 0),
                ...
                (this.destroy = function () {
                    n.hide(), n.find(".descriptions, .legends").hide(), (u = null), (a = null);
                }),
                (this.getLegendContainer = function (e) {
                    return n.find(".legendWrapper[data-webmap=" + e + "]");
                }),
                (this.focus = function () {
                    n.find(".entry.active .description > *[tabindex=0]").eq(0).focus();
                });
        };
    }),
    define("lib-build/css!storymaps/tpl/ui/mobile/Header", [], function () { }),
    define("lib-build/tpl!storymaps/tpl/ui/mobile/HeaderMenuTpl", [], function () {
        return function (obj) {
            obj || (obj = {});
            var __t,
                __p = "",
    ...
    define("lib-build/tpl!storymaps/tpl/ui/mobile/HeaderMenuEntryTpl", [], function () {
        return function (obj) {
            obj || (obj = {});
            var __t,
                __p = "",
                __e = _.escape;
            with (obj) __p += '<div class="menu-entry">\n	<div class="menu-title">' + ((__t = title) == null ? "" : __t) + "</div>\n</div>";
            return __p;
        };
    }),
    define("storymaps/tpl/ui/mobile/Header", ["lib-build/css!./Header", "lib-build/tpl!./HeaderMenuTpl", "lib-build/tpl!./HeaderMenuEntryTpl", "storymaps/common/utils/HeaderHelper", "storymaps/common/utils/CommonHelper"], function (
        e,
        t,
        n,
        r,
        ...
        return function (s, o, u) {
            function a(e) {
                r.setSocial(s, e), r.initEvents(s);
            }
            function f() {
                s.find(".menu").slideToggle();
            }
            function l(e, i, o, u, a, f) {
                var l = "",
                    c = o.length;
                $.each(o, function (e, t) {
                    var r = t.title;
                    if (a == "bullet" || a == "accordion") f.reverse ? (r = c - e + (r ? " - " + r : "")) : (r = e + 1 + (r ? " - " + r : ""));
                    l += n({ title: r || "&nbsp;" });
                }),
                    s.find(".menu").html(t({ subtitle: i, menuIndex: l })),
                    s.find(".subtitle").toggle(!e.compactSize),
                    r.setLink(s, e),
                    r.setLogo(s, e),
                    (e.logoURL == "NO_LOGO" || !e.logoURL || !e.linkText) && s.find(".menu-header").addClass("centered"),
                    s.find(".menu-entry").click(h).eq(u).addClass("active");
            }
            function c(e) {
                s.css({ color: e.headerTitle, backgroundColor: e.header }),
                    s.find(".menu").css({ color: e.text, backgroundColor: e.panel }),
                    i.addCSSRule(".headerMobile ::-webkit-scrollbar-thumb { background-color:" + e.header + "; }", "MobileheaderScrollbar");
            }
            function h() {
            ...
            function p() {
                s.find(".menu-btn").click(f);
            }
            (this.init = function (e) {
                (e = e || {}), s.find(".title").html(e.title), a(e.headerCfg), l(e.headerCfg, e.subtitle, e.entries, e.entryIndex, e.appLayout, e.layoutOpt), c(e.appColors);
            }),
                ...
                (this.showEntryIndex = function (e) {
                    setTimeout(function () {
                        s.find(".menu-entry").removeClass("active").eq(e).addClass("active");
                    }, 500);
                }),
                (this.toggleSocialBtnAppSharing = function (e) {
                    r.toggleSocialBtnAppSharing(s, e);
                }),
                (this.enableAutoplay = function () {
                    s.find(".share-all").addClass("disabled").tooltip({ title: i18n.viewer.headerFromCommon.tooltipAutoplayDisabled, container: "body", placement: "left" });
                }),
                p();
        };
    }),
    define("lib-build/css!storymaps/tpl/ui/mobile/EntryInfo", [], function () { }),
    define("storymaps/tpl/ui/mobile/EntryInfo", ["lib-build/css!./EntryInfo", "./PopupUtils", "../StoryText"], function (e, t, n) {
        return function (r) {
            function u() {
                var e = a(),
                    r = i[s].description;
                if (!e.is(":visible")) {
                    e.find(".description").html(n.prepareContentIframe(n.prepareEditorContent(r)));
                    if (e.find(".content-toggles")) {
                        var u = o.description && r && o.legend;
                        e.toggleClass("noToggle", !u),
                            e.find(".content-toggles").toggle(u),
                            e
                                .find(".content-toggles .btn")
                                .eq(o.description && r ? 0 : 1)
                                .click();
                    }
                }
                t.open(e);
            ...
            var i = null,
                ...
                o = null;
            (this.init = function (e) {
                (e = e || {}), (i = e.entries), (s = e.entryIndex);
            }),
                (this.resize = function () { }),
                (this.showEntryIndex = function (e, t) {
                    (o = t), (s = e), r.toggle(o.description || o.legend), a().hide().addClass("hideContent");
                }),
                (this.onPopupContentToggle = function () {
                    var e = $(this),
                        t = $(this).index(),
                        n = a();
                    e.siblings().removeClass("btn-primary"), e.addClass("btn-primary"), n.find(".content-container").hide().eq(t).show();
                }),
                f();
        };
    }),
    define("lib-build/css!storymaps/tpl/ui/mobile/Footer", [], function () { }),
    define("lib-build/tpl!storymaps/tpl/ui/mobile/FooterTpl", [], function () {
        return function (obj) {
            obj || (obj = {});
            var __t,
                __p = "",
    ...
    define("lib-build/tpl!storymaps/tpl/ui/mobile/FooterEntryTpl", [], function () {
        return function (obj) {
            function print() {
                __p += __j.call(arguments, "");
            }
            ...
            var __t,
                ...
                __j = Array.prototype.join;
            with (obj)
            (__p += '<div class="entry swiper-slide">\n	<div class="title">\n		' + ((__t = title) == null ? "" : __t) + '\n		<!--  \n		<span class="glyphicon glyphicon-info-sign info-btn" style="'),
                enableInfo || (__p += "display: none;"),
                (__p += '"></span>\n		<span class="glyphicon glyphicon-tower legend-btn" style="'),
                enableLegend || (__p += "display: none;"),
...
var Swiper = function (e, t) {
    ...
    function T() {
        function o(e) {
            var n = new Image();
            (n.onload = function () {
                i && i.imagesLoaded !== undefined && i.imagesLoaded++, i.imagesLoaded === i.imagesToLoad.length && (i.reInit(), t.onImagesReady && i.fireCallback(t.onImagesReady, i));
            }),
                (n.src = e);
        }
        var e = i.h.addEventListener,
            n = t.eventTarget === "wrapper" ? i.wrapper : i.container;
        !i.browser.ie10 && !i.browser.ie11
            ? (i.support.touch && (e(n, "touchstart", I), e(n, "touchmove", U), e(n, "touchend", z)), t.simulateTouch && (e(n, "mousedown", I), e(document, "mousemove", U), e(document, "mouseup", z)))
            : (e(n, i.touchEvents.touchStart, I), e(document, i.touchEvents.touchMove, U), e(document, i.touchEvents.touchEnd, z)),
    ...
    function D(e) {
        ...
        (i.clickedTarget = e.target), (i.clickedSlideIndex = i.slides.indexOf(i.clickedSlide)), (i.clickedSlideLoopIndex = i.clickedSlideIndex - (i.loopedSlides || 0));
    }
    function P(e) {
    ...
    function U(e) {
        ...
        if (!B || e.touches.length === 1) {
            ...
            if (t.resistance && t.resistance !== "100%") {
                var s;
                i.positions.current > 0 && ((s = 1 - i.positions.current / l / 2), s < 0.5 ? (i.positions.current = l / 2) : (i.positions.current = i.positions.current * s));
            ...
            t.resistance &&
                t.resistance === "100%" &&
                (i.positions.current > 0 && (!t.freeMode || !!t.freeModeFluid) && (i.positions.current = 0), i.positions.current < -x() && (!t.freeMode || !!t.freeModeFluid) && (i.positions.current = -x()));
            ...
            return (
                (t.freeMode || t.watchActiveIndex) && i.updateActiveSlide(i.positions.current),
                t.grabCursor && ((i.container.style.cursor = "move"), (i.container.style.cursor = "grabbing"), (i.container.style.cursor = "-moz-grabbin"), (i.container.style.cursor = "-webkit-grabbing")),
                q || (q = i.touches.current),
                R || (R = new Date().getTime()),
                (i.velocity = (i.touches.current - q) / (new Date().getTime() - R) / 2),
                Math.abs(i.touches.current - q) < 2 && (i.velocity = 0),
                (q = i.touches.current),
                (R = new Date().getTime()),
                i.callPlugins("onTouchMoveEnd"),
                t.onTouchMove && i.fireCallback(t.onTouchMove, i, e),
                !1
            );
        }
    }
    function z(e) {
        ...
        if (!i.isMoved && t.freeMode) {
            (i.isMoved = !1), t.onTouchEnd && i.fireCallback(t.onTouchEnd, i, e), i.callPlugins("onTouchEnd");
            return;
        }
        if (!i.isMoved || i.positions.current > 0 || i.positions.current < -u) {
            i.swipeReset(), t.onTouchEnd && i.fireCallback(t.onTouchEnd, i, e), i.callPlugins("onTouchEnd");
            return;
        }
        i.isMoved = !1;
        if (t.freeMode) {
            ...
            (!t.freeModeFluid || s >= 300) && i.updateActiveSlide(i.positions.current), t.onTouchEnd && i.fireCallback(t.onTouchEnd, i, e), i.callPlugins("onTouchEnd");
            return;
        }
        ...
        if (t.slidesPerView === "auto") {
            ...
            for (var S = 0; S < i.slides.length; S++) {
                (E = d ? i.slides[S].getWidth(!0, t.roundLengths) : i.slides[S].getHeight(!0, t.roundLengths)), (w += E);
                if (w > b) {
                    y = E;
                    break;
                }
    ...
    function V(e, n, r) {
        function u() {
            ...
            (a += (f * h) / (1e3 / 60)),
                (c = l === "toNext" ? a > e : a < e),
                c
                    ? (i.setWrapperTranslate(Math.round(a)),
                        (i._DOMAnimating = !0),
                        window.setTimeout(function () {
                            u();
                        }, 1e3 / 60))
                    : (t.onSlideChangeEnd && (n === "to" ? r.runCallbacks === !0 && i.fireCallback(t.onSlideChangeEnd, i) : i.fireCallback(t.onSlideChangeEnd, i)), i.setWrapperTranslate(e), (i._DOMAnimating = !1));
        }
    ...
    t = t || {};
    for (var h in c)
        if (h in t && typeof t[h] == "object") for (var p in c[h]) p in t[h] || (t[h][p] = c[h][p]);
        else h in t || (t[h] = c[h]);
        ...
        (i._extendSwiperSlide = function (e) {
            return (
                ...
                (e.insertAfter = function (n) {
                    ...
                    return (
                        t.loop
                            ? ((r = i.slides[n + 1 + i.loopedSlides]), r ? i.wrapper.insertBefore(e, r) : i.wrapper.appendChild(e), i.removeLoopedSlides(), i.calcSlides(), i.createLoop())
                            : ((r = i.slides[n + 1]), i.wrapper.insertBefore(e, r)),
                        i.reInit(),
                        e
                    );
                }),
        ...
        (i.fireCallback = function () {
            ...
            if (Object.prototype.toString.call(e) === "[object Array]") for (var n = 0; n < e.length; n++) typeof e[n] == "function" && e[n](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                ...
                Object.prototype.toString.call(e) === "[object String]"
                    ? t["on" + e] && i.fireCallback(t["on" + e], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
    ...
    (i.callPlugins = function (e, t) {
        ...
        (i.init = function (e, n) {
            ...
            if (t.slidesPerView === "auto") {
                ...
                t.slidesOffset > 0 && ((g.style.paddingLeft = ""), (g.style.paddingRight = ""), (g.style.paddingTop = ""), (g.style.paddingBottom = "")),
                    ...
                    t.centeredSlides &&
                    (d
                        ? ((i.wrapperLeft = (l - this.slides[0].getWidth(!0, t.roundLengths)) / 2), (i.wrapperRight = (l - i.slides[i.slides.length - 1].getWidth(!0, t.roundLengths)) / 2))
                        : ((i.wrapperTop = (l - i.slides[0].getHeight(!0, t.roundLengths)) / 2), (i.wrapperBottom = (l - i.slides[i.slides.length - 1].getHeight(!0, t.roundLengths)) / 2))),
                    d
                        ? (i.wrapperLeft >= 0 && (g.style.paddingLeft = i.wrapperLeft + "px"), i.wrapperRight >= 0 && (g.style.paddingRight = i.wrapperRight + "px"))
                        : (i.wrapperTop >= 0 && (g.style.paddingTop = i.wrapperTop + "px"), i.wrapperBottom >= 0 && (g.style.paddingBottom = i.wrapperBottom + "px")),
                    (v = 0);
                var w = 0;
                (i.snapGrid = []), (i.slidesGrid = []), (c = 0);
                for (m = 0; m < i.slides.length; m++) {
                    (a = i.slides[m].getWidth(!0, t.roundLengths)), (f = i.slides[m].getHeight(!0, t.roundLengths)), t.calculateHeight && (c = Math.max(c, f));
                    var E = d ? a : f;
                    if (t.centeredSlides) {
                        ...
                        if (E > l)
                            ...
                            else if (l !== 0) for (var C = 0; C <= Math.floor(E / l); C++) i.snapGrid.push(v + l * C);
                ...
                } else (f = d ? i.height : i.height / t.slidesPerView), t.roundLengths && (f = Math.round(f)), (p = d ? i.height : i.slides.length * f);
                (a = d ? i.width / t.slidesPerView : i.width),
                    ...
                    (i.slidesGrid = []);
                for (m = 0; m < i.slides.length; m++)
                    i.snapGrid.push(v), i.slidesGrid.push(v), (v += o), t.cssWidthAndHeight || (parseFloat(a) > 0 && (i.slides[m].style.width = a + "px"), parseFloat(f) > 0 && (i.slides[m].style.height = f + "px"));
            }
        ...
        (i.resizeFix = function (e) {
            i.callPlugins("beforeResizeFix"),
                ...
                t.freeMode
                    ? i.getWrapperTranslate() < -x() && (i.setWrapperTransition(0), i.setWrapperTranslate(-x()))
                    : (i.swipeTo(t.loop ? i.activeLoopIndex : i.activeIndex, 0, !1),
                        t.autoplay &&
                        (i.support.transitions && typeof G != "undefined"
                            ? typeof G != "undefined" && (clearTimeout(G), (G = undefined), i.startAutoplay())
                            : typeof Y != "undefined" && (clearInterval(Y), (Y = undefined), i.startAutoplay()))),
    ...
    (i.swipeNext = function (e) {
        ...
        (i.swipeTo = function (e, n, r) {
            (e = parseInt(e, 10)), i.callPlugins("onSwipeTo", { index: e, speed: n }), t.loop && (e += i.loopedSlides);
            var s = i.getWrapperTranslate();
            if (e > i.slides.length - 1 || e < 0) return;
            var u;
            return t.slidesPerView === "auto" ? (u = -i.slidesGrid[e]) : (u = -e * o), u < -x() && (u = -x()), u === s ? !1 : ((r = r === !1 ? !1 : !0), V(u, "to", { index: e, speed: n, runCallbacks: r }), !0);
        }),
        (i._queueStartCallbacks = !1),
        ...
        (i.updateActiveSlide = function (e) {
            ...
            if (t.slidesPerView === "auto") {
                ...
                if (i.activeIndex < 0) {
                    for (n = 0; n < i.slidesGrid.length - 1; n++) if (-e > i.slidesGrid[n] && -e < i.slidesGrid[n + 1]) break;
            ...
            if (i.support.classList) {
                var a;
                for (n = 0; n < i.slides.length; n++) (a = i.slides[n]), a.classList.remove(t.slideActiveClass), i.visibleSlides.indexOf(a) >= 0 ? a.classList.add(t.slideVisibleClass) : a.classList.remove(t.slideVisibleClass);
                ...
                for (n = 0; n < i.slides.length; n++) (i.slides[n].className = i.slides[n].className.replace(f, "").replace(l, "")), i.visibleSlides.indexOf(i.slides[n]) >= 0 && (i.slides[n].className += " " + t.slideVisibleClass);
        ...
        (i.updatePagination = function (e) {
            ...
            if (t.paginationAsRange) {
                ...
                t.loop
                    ? s[i.activeLoopIndex] && (s[i.activeLoopIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass)
        ...
        (i.calcVisibleSlides = function (e) {
            ...
            for (var a = 0; a < i.slides.length; a++) {
                (r += s), t.slidesPerView === "auto" ? (s = d ? i.h.getWidth(i.slides[a], !0, t.roundLengths) : i.h.getHeight(i.slides[a], !0, t.roundLengths)) : (s = o), (u = r + s);
                var f = !1;
    ...
    (i.startAutoplay = function () {
        if (i.support.transitions) {
            ...
            i.callPlugins("onAutoplayStart"), t.onAutoplayStart && i.fireCallback(t.onAutoplayStart, i), Z();
        } else {
        ...
        (i.stopAutoplay = function (e) {
            if (i.support.transitions) {
                ...
                G && clearTimeout(G),
                    (G = undefined),
                    e &&
                    !t.autoplayDisableOnInteraction &&
                    i.wrapperTransitionEnd(function () {
                        Z();
                    }),
                    i.callPlugins("onAutoplayStop"),
                    t.onAutoplayStop && i.fireCallback(t.onAutoplayStop, i);
            } else Y && clearInterval(Y), (Y = undefined), i.callPlugins("onAutoplayStop"), t.onAutoplayStop && i.fireCallback(t.onAutoplayStop, i);
        }),
        (i.loopCreated = !1),
...
(Swiper.prototype = {
    ...
    getWrapperTranslate: function (e) {
        ...
        var t = this.wrapper,
            ...
            s;
        return (
            typeof e == "undefined" && (e = this.params.mode === "horizontal" ? "x" : "y"),
            this.support.transforms && this.params.useCSS3Transforms
                ? ((i = window.getComputedStyle(t, null)),
                    window.WebKitCSSMatrix
                        ...
                        : ((s = i.MozTransform || i.OTransform || i.MsTransform || i.msTransform || i.transform || i.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")), (n = s.toString().split(","))),
                    e === "x" && (window.WebKitCSSMatrix ? (r = s.m41) : n.length === 16 ? (r = parseFloat(n[12])) : (r = parseFloat(n[4]))),
                    e === "y" && (window.WebKitCSSMatrix ? (r = s.m42) : n.length === 16 ? (r = parseFloat(n[13])) : (r = parseFloat(n[5]))))
                : (e === "x" && (r = parseFloat(t.style.left, 10) || 0), e === "y" && (r = parseFloat(t.style.top, 10) || 0)),
            r || 0
        );
    },
    ...
    h: {
        getWidth: function (e, t, n) {
            ...
            var r = window.getComputedStyle(e, null).getPropertyValue("width"),
                i = parseFloat(r);
            if (isNaN(i) || r.indexOf("%") > 0) i = e.offsetWidth - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"));
        ...
        getHeight: function (e, t, n) {
            ...
            var r = window.getComputedStyle(e, null).getPropertyValue("height"),
                i = parseFloat(r);
            if (isNaN(i) || r.indexOf("%") > 0) i = e.offsetHeight - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"));
        ...
        getOffset: function (e) {
            ...
            return document.documentElement && !window.pageYOffset && ((s = document.documentElement.scrollTop), (o = document.documentElement.scrollLeft)), { top: t.top + s - r, left: t.left + o - i };
        },
        ...
        windowScroll: function () {
            "use strict";
            if (typeof pageYOffset != "undefined") return { left: window.pageXOffset, top: window.pageYOffset };
            if (document.documentElement) return { left: document.documentElement.scrollLeft, top: document.documentElement.scrollTop };
        },
    ...
    define.amd &&
    define("lib-app/swiper/idangerous.swiper", [], function () {
        "use strict";
        return Swiper;
    }),
    define("lib-build/css!lib-app/swiper/idangerous.swiper", [], function () { }),
    define("storymaps/tpl/ui/mobile/Footer", [
        "lib-build/css!./Footer",
        ...
        return function (i, u, a) {
            function h(e, r, s) {
                ...
                (l = null),
                    $.each(e, function (t, i) {
                        var o = i.title,
                            u = i18n.viewer.mobileFooter.lblEnd;
                        t != h - 1 && e[t + 1].title ? (u = i18n.viewer.mobileFooter.lblNext + ": " + e[t + 1].title) : t === 0 && (u = "");
                        if (r == "bullet" || r == "accordion") s.reverse ? (o = h - t + (o ? " - " + o : "")) : (o = t + 1 + (o ? " - " + o : ""));
                        f += n({ title: o || "&nbsp;", next: u, enableLegend: i.media.type == "webmap", enableInfo: !!i.description });
                    }),
                    i.html(t({ entriesHTML: f })),
                    (c = new o(i.find(".swiper-container")[0], {
                        mode: "horizontal",
                        loop: !1,
                        keyboardControl: !1,
                        onSlideChangeEnd: function (e) {
                            l != e.activeIndex && a(e.activeIndex), d(), c.resizeFix();
                        },
                    ...
                    v(),
                    d(),
                    e.length < 2 && (i.tooltip("destroy"), !u && i.hasClass("hasDesktopBtn") && i.removeClass("hasDesktopBtn").addClass("oneEntry"));
            }
            function p(e) {
                i.css({ color: e.text, backgroundColor: e.panel }),
                    r.addCSSRule(".footerMobile .tooltip-inner { 						background-color: " + e.header + "; 						color: " + e.headerTitle + "; 					}					.footerMobile .tooltip-arrow { 						border-top-color: " + e.header + " !important; 					}", "MobileFooterTooltip");
            }
            function d() {
                i.find(".embed-btn-left").toggleClass("disabled", !c.activeIndex), i.find(".embed-btn-right").toggleClass("disabled", c.activeIndex === c.slides.length - 1);
            }
            function v() {
                i.find(".embed-btn").click(function () {
                    var e = $(this).parent();
                    e.hasClass("disabled") || (e.hasClass("embed-btn-left") ? c.swipePrev() : c.swipeNext());
                });
            }
            function m() {
                $("body").hasClass("hasTouch")
                    ? (i
                        .tooltip({
                            title: '<span class="footerTooltip"><span class="glyphicon glyphicon-resize-horizontal" style="vertical-align: -2px;"></span> ' + i18n.viewer.mobileFooter.swipeInvite + "</span>",
                            html: !0,
                            trigger: "manual",
                    ...
                    : i.addClass("hasDesktopBtn");
            }
            var f = null,
                l = null,
                c = null;
            (this.init = function (e) {
                (e = e || {}), (f = e.entries), h(e.entries, e.appLayout, e.layoutOpt), p(e.appColors);
            }),
                (this.update = function (e) {
                    p(e.appColors);
                }),
    ...
    define("storymaps/common/mapcontrols/command/MapCommand", [
        ...
        return function (a, f, l, c) {
            ...
            function g() {
                ...
                setTimeout(function () {
                    ...
                    navigator.geolocation.getCurrentPosition(
                        ...
                        { enableHighAccuracy: !0, maximumAge: 12e4, timeout: e }
                    ),
                    setTimeout(function () {
                        t || b();
                    }, e);
            ...
            var h = 0,
                p = $('<div class="esriSimpleSliderIncrementButton"><div class="mapCommandHomeBtn" title="' + (i18n.viewer.mapFromCommon ? i18n.viewer.mapFromCommon.home : "Zoom Home") + '" role="button" tabindex="0"></div></div>'),
                d = new i("resources/common/icons/mapcommand-location-marker.png", 21, 21),
                v = new s({ id: "locateLayer" });
            p.click(function () {
                ...
                (window.top !== window.self ? !1 : window.location.protocol.search("https") >= 0) &&
                ($(".esriSimpleSlider", a.container).after('<div class="esriSimpleSlider esriSimpleSliderVertical mapCommandLocation"></div>'),
                    $(".mapCommandLocation", a.container).click(g),
                    this.enableLocationButton(c),
                    a.addLayer(v)),
                this.setMobile(app.appCfg.mapCommandLargerTouch || (app.appCfg.mapCommandLargerTouch === undefined && t("touch")));
        };
    }),
    ...
    define("storymaps/common/mapcontrols/legend/Legend", [
        ...
        return function (n, u, a) {
            function d() {
                h.find(".legendDijitContainer").html('<div class="legendDijit"></div>'), (l = new i({ map: n.map, layerInfos: s.getLegendLayers(n) }, h.find(".legendDijit")[0])), l.startup();
            }
            function v() {
                l && l.destroy(), (l = null);
            }
            ...
            function g() {
                h.find(".titleBtn").click(m),
                    h.find(".settingsGear").click(function () {
                        h.find(".settingsOverlay").is(":visible")
                            ? h.off("mouseleave")
                            : h.mouseleave(function () {
                                h.find(".settingsOverlay").toggle(), h.off("mouseleave"), h.find(".content").removeClass("settingsOpen");
                            }),
                            h.find(".settingsOverlay").toggle(),
                            h.find(".content").toggleClass("settingsOpen");
                    }),
                    h.find(".expandStartup").change(y),
                    f.updatePlacementSettings(a);
            }
            function y() {
            ...
            var f = this,
                ...
                c = null,
                h = a.container,
                p = { isInBuilder: u, title: i18n.viewer.mapFromCommon.legend };
            u && ((p.settings = i18n.commonMapControls.common.settings), (p.openDefault = i18n.commonMapControls.common.openDefault)),
                h.html(e(p)),
                ...
                (this.setColors = function (e) {
                    h.find(".legendContainer").css({ backgroundColor: e.mapControls, color: e.text }),
                        h.find(".titleBtn").css("color", e.softText),
                        h.find(".settingsGear, .collapseBtn").css("color", e.softBtn),
                        r.addCSSRule(".mainMediaContainer .legendContainer ::-webkit-scrollbar-thumb { background-color:" + e.header + "; }", "MapControlLegendDropdownScrollbar");
                }),
        ...
        return function (obj) {
            ...
            (__p +=
                ...
                (__p +=
                    ...
                    ((__t = basemapGalleryBtnLabel) == null ? "" : __t) +
                    ...
                    ((__t = expandFactorLabel) == null ? "" : __t) +
    ...
    define("storymaps/common/mapcontrols/overview/Overview", [
        ...
        return function (n, i, s) {
            function c(e) {
                i.find(".overviewMapContainer").html('<div class="overviewMap"></div>'), (o = new r({ map: n, visible: !0, color: "transparent", opacity: 1 }, i.find(".overviewMap")[0])), o.startup();
                var t = e ? e.header : a;
            ...
            var o = null,
                u = null,
                a = null,
                f = { isInBuilder: s, title: i18n.viewer.mapFromCommon.overview, overlayHeader: "", basemapGalleryBtnLabel: "", expandFactorLabel: "" };
            s &&
                ((f.settings = i18n.commonMapControls.common.settings),
                    (f.openDefault = i18n.commonMapControls.common.openDefault),
                    (f.basemapGalleryBtnLabel = i18n.commonMapControls.overview.basemapGalleryBtnLabel),
                    (f.expandFactorLabel = i18n.commonMapControls.overview.expandFactorLabel)),
                i.append(e(f)),
                ...
                (this.setColors = function (e) {
                    (a = e.mapControls),
                        i.find(".overviewContainer").css({ backgroundColor: a, color: e.text }),
                        i.find(".titleBtn").css("color", e.softText),
                        i.find(".settingsGear, .collapseBtn").css("color", e.softBtn),
                        i.find(".ovwHighlight").css("border", "3px solid " + a);
                }),
                (this.setSettings = function (e) {
    ...
    define("storymaps/common/mapcontrols/geocoder/Geocoder", ["lib-build/tpl!./Geocoder", "lib-build/css!./Geocoder", "../../utils/CommonHelper"], function (e, t, n) {
        return function (r, i, s, o) {
            function l() {
                $(r.container).find(".esriSimpleSlider").last().after(e({})), c(), u.toggle(s);
            }
            function c() {
                var e = $(r.container).find(".geocoderBtn");
                f = n.createGeocoder({ map: r, domNode: e.find(".geocoderContainer")[0], enableButtonMode: !0, searchOptions: o }).then(function (t) {
            ...
            (this.toggle = function (e) {
                if (!app.isInBuilder) {
                    var t = app.data.getWebAppData();
                    if (t.getMapOptions && (!t.getMapOptions().geocoder || !t.getMapOptions().geocoder.enable)) return;
                    if (t.getGeneralOptions && !t.getGeneralOptions().geocoder) return;
                }
                var n = $(r.container).find(".geocoderBtn");
                !a && (!f || f.isRejected()) && c(e), $(r.container).toggleClass("has-geocoder", e), n.toggle(e);
            }),
                l();
        };
    }),
    ...
    !(function (e) {
        var t = function (t, n) {
            ...
            this.range
                ...
                : ((this.value = [Math.max(this.min, Math.min(this.max, this.value))]), this.handle2.addClass("hide"), this.selection == "after" ? (this.value[1] = this.max) : (this.value[1] = this.min)),
                ...
                this.layout(),
                this.touchCapable ? this.picker.on({ touchstart: e.proxy(this.mousedown, this) }) : this.picker.on({ mousedown: e.proxy(this.mousedown, this) }),
                r === "show" ? this.picker.on({ mouseenter: e.proxy(this.showTooltip, this), mouseleave: e.proxy(this.hideTooltip, this) }) : this.tooltip.addClass("hide");
        };
        (t.prototype = {
            constructor: t,
            over: !1,
            ...
            layout: function () {
                (this.handle1Stype[this.stylePos] = this.percentage[0] + "%"),
                    ...
                    this.orientation == "vertical"
                        ? ((this.selectionElStyle.top = Math.min(this.percentage[0], this.percentage[1]) + "%"), (this.selectionElStyle.height = Math.abs(this.percentage[0] - this.percentage[1]) + "%"))
                        : ((this.selectionElStyle.left = Math.min(this.percentage[0], this.percentage[1]) + "%"), (this.selectionElStyle.width = Math.abs(this.percentage[0] - this.percentage[1]) + "%")),
                    this.range
                        ? (this.tooltipInner.text(this.formater(this.value[0]) + " : " + this.formater(this.value[1])),
                            (this.tooltip[0].style[this.stylePos] =
                                (this.size * (this.percentage[0] + (this.percentage[1] - this.percentage[0]) / 2)) / 100 - (this.orientation === "vertical" ? this.tooltip.outerHeight() / 2 : this.tooltip.outerWidth() / 2) + "px"))
                        : (this.tooltipInner.text(this.formater(this.value[0])),
                            (this.tooltip[0].style[this.stylePos] = (this.size * this.percentage[0]) / 100 - (this.orientation === "vertical" ? this.tooltip.outerHeight() / 2 : this.tooltip.outerWidth() / 2) + "px"));
            },
            mousedown: function (t) {
                this.touchCapable && t.type === "touchstart" && (t = t.originalEvent), (this.offset = this.picker.offset()), (this.size = this.picker[0][this.sizePos]);
                ...
                (this.percentage[this.dragged] = n),
                    this.layout(),
                    this.touchCapable
                        ? e(document).on({ touchmove: e.proxy(this.mousemove, this), touchend: e.proxy(this.mouseup, this) })
                        : e(document).on({ mousemove: e.proxy(this.mousemove, this), mouseup: e.proxy(this.mouseup, this) }),
                    (this.inDrag = !0);
            ...
            mousemove: function (e) {
                ...
                this.range &&
                    (this.dragged === 0 && this.percentage[1] < t
                        ? ((this.percentage[0] = this.percentage[1]), (this.dragged = 1))
                        : this.dragged === 1 && this.percentage[0] > t && ((this.percentage[1] = this.percentage[0]), (this.dragged = 0))),
            ...
            mouseup: function (t) {
                this.touchCapable ? e(document).off({ touchmove: this.mousemove, touchend: this.mouseup }) : e(document).off({ mousemove: this.mousemove, mouseup: this.mouseup }),
                    (this.inDrag = !1),
            ...
            calculateValue: function () {
                ...
                return (
                    this.range
                        ? ((e = [this.min + Math.round((this.diff * this.percentage[0]) / 100 / this.step) * this.step, this.min + Math.round((this.diff * this.percentage[1]) / 100 / this.step) * this.step]), (this.value = e))
                        : ((e = this.min + Math.round((this.diff * this.percentage[0]) / 100 / this.step) * this.step), (this.value = [e, this.value[1]])),
                    e
                );
            },
            ...
            (e.fn.slider = function (n, r) {
                return this.each(function () {
                    var i = e(this),
                        s = i.data("slider"),
                        o = typeof n == "object" && n;
                    s || i.data("slider", (s = new t(this, e.extend({}, e.fn.slider.defaults, o)))), typeof n == "string" && s[n](r);
                });
            }),
    ...
    define("storymaps/common/ui/autoplay/Autoplay", [
        ...
        return function (n, o) {
            ...
            function p() {
                if (!u) return;
                console.log("Autoplay: pause"), (u = !1), a && clearTimeout(a);
            }
            function d(e) {
                (f = o()),
                    (a = setTimeout(function () {
            ...
            function b() {
                var e = Date.now();
                l > Date.now() - 150 && n.removeClass("fade"), (l = e);
            }
            function w() {
            ...
            (!n || !o || typeof o != "function") && console.log("Autoplay: failed to initialize"),
                ...
                (this.init = function (e) {
                    if (!e) return;
                    if (e.color)
                        if (e.useBackdrop) n.find(".backdrop").css({ backgroundColor: e.color, display: "block" }), n.find(".autoplay-container").css({ backgroundColor: "inherit" });
                        else {
                            n.find(".autoplay-container").css({ backgroundColor: e.color });
                            if (e.color == "#FFF8E9" || e.color == "#FFFFFF" || e.color == "#D4E6C3") e.themeMajor = "white2";
                        }
    ...
    ], function (e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N, C) {
        return function (y) {
            function w(e) {
                ...
                return (
                    r.layers.forEach(function (e) {
                        _.find(i, function (t) {
                            if (t.id === e.id) return (e.name = t.name), (e.title = t.title), !0;
                        });
                    }),
                    r
                );
            ...
            function k(e, t) {
                var n = i.getLegendPlacement(),
                    r = e.siblings(".legend");
                return $("body").hasClass("mobile-view") ? ((n = "panel"), (r = e.siblings(".mobilePopup").find(".legendMobile"))) : n == "panel" && (r = app.ui.descLegendPanel.getLegendContainer(t)), { mode: n, container: r };
            }
            function L() {
                var e = app.data.getStoryLength(),
                    t = 0,
                    n = parseInt(E.getUrlParams().entry, 10);
                app.data.cleanEntriesMarkup(), n && (t = n - 1), t >= e && (t = 0), e && app.data.setCurrentSectionIndex(t);
                if (e) {
                    $("body").addClass("layout-" + i.getLayoutId()), D(), b.handleWindowResize();
                    if (app.data.getCurrentSection().media.type != "webmap") A();
                    else {
                        var r, s;
                        (r = x.subscribe("story-loaded-map", function () {
                            r.remove(), s.remove(), A();
                        })),
                            (s = x.subscribe("story-entry-map-timeout", function () {
                                r.remove(), s.remove(), A();
                            }));
                    }
                } else A();
            ...
            function A() {
                i.isBlank()
                    ? app.isInBuilder
                        ? b.isProd()
                            ? y.showInitPopup()
                            : b.portalLogin().then(y.showInitPopup, function () {
                                b.initError("noLayerNoHostedFS");
                            })
                        : E.getAppID(b.isProd())
                            ? app.userCanEdit
                                ? E.switchToBuilder()
                                : b.initError("notConfiguredDesktop")
                            : b.initError("noLayer")
                    : b.appInitComplete(),
                    y && y.updateUI();
            }
            function O() {
                var e = i.getLayoutId(),
                    ...
                    r = app.data.getStoryEntries(),
                    s = app.data.getCurrentSectionIndex();
                e == "accordion"
                    ? (n.panel.position == "left"
                        ? $("#accordionPanel").parent().children().eq(0).is("#accordionPanel") || $("#mainStagePanel").before($("#accordionPanel"))
                        : $("#accordionPanel").parent().children().eq(0).is("#mainStagePanel") || $("#accordionPanel").before($("#mainStagePanel")),
                        app.ui.accordionPanel.init(r, s, n, t),
                        app.ui.descLegendPanel.destroy())
                    : (app.ui.navBar.init(r, s, e, n, t), app.ui.descLegendPanel.init(r, s, n, t, R())),
                    M() &&
                    (app.ui.mobileHeader.init({ title: i.getTitle(), subtitle: i.getSubtitle(), headerCfg: b.getHeaderUserCfg({ useMobileLogo: !0 }), entries: r, entryIndex: s, appLayout: e, layoutOpt: n, appColors: t }),
                        app.ui.mobileEntryInfo.init({ entries: r, entryIndex: s }),
                        h.setColors(t),
                        app.ui.mobileFooter.init({ entries: r, entryIndex: s, appLayout: e, layoutOpt: n, appColors: t })),
                    app.ui.autoplay && app.ui.autoplay.init({ color: t.panel, themeMajor: t.themeMajor, useBackdrop: !1 });
            }
            function M() {
                return S("ie") === undefined || S("ie") > 8;
            }
            function D() {
                app.ui.mainStage.updateMainMediaContainers(), O(), B(), C.createMediaFullScreenButton(), C.styleSectionPanelContent(), q(app.data.getCurrentSectionIndex()), y && y.updateUI();
            }
            function P(e) {
                D(), q(e.index);
            }
            function H() {
                var e = i.getLayoutId(),
                    t = i.getColors(),
                    n = i.getLayoutOptions();
                e == "accordion" ? app.ui.accordionPanel.update(n, t) : (app.ui.navBar.update(e, n, t), app.ui.descLegendPanel.update(n, t, R())),
                    M() && (app.ui.mobileHeader.update({ layoutOpt: n, appColors: t }), h.setColors(t), app.ui.mobileFooter.update({ appColors: t }));
            }
            function B() {
                var e = i.getColors();
                E.addCSSRule(".textEditorContent a, .accordionPanel .builder-lbl { color: " + e.textLink + "; }"),
                    E.addCSSRule(".accordionPanel .builder-content-panel-group:not(.disabled):hover .builder-lbl { color: " + e.text + " !important; }");
            }
            function j() {
                var e = app.data.getCurrentSection(),
                    t = e && e.media && e.media.type == "webmap",
                    n = 0;
                if (t) {
                    var r = $(".mainMediaContainer.active"),
                        i = r.find(".geocoderBtn"),
                        s = r.find(".mapCommandLocation"),
                        o = r.find(".esriSimpleSliderTL");
                    n = Math.max(i && i.position() ? i.position().top + i.height() : 0, s && s.position() ? s.position().top + s.height() : 0, o && o.position() ? o.position().top + o.height() : 0);
                }
                $("#descLegendPanel .descLegendPanelInner").css("min-height", n ? n + 20 : "inherit");
            }
            function F() {
                var e = ["tab", "bullet"],
                    t = ["small", "medium", "large"],
                    n = "body:not(.mobile-view).layout-";
                $.each(app.cfg.LAYOUTS, function (r, i) {
                    e.indexOf(i.id) != -1 &&
                        $.each(t, function (e, t) {
                            var r = "calc(" + parseInt(i.sizes[t], 10) + "% + 20px)";
                            E.addCSSRule(n + i.id + "-left-" + t + " .esriSimpleSlider," + n + i.id + "-left-" + t + " .geocoderBtn" + "{ left:" + r + "; }"),
                                E.addCSSRule(n + i.id + "-left-" + t + " .mainMediaContainer .overviewContainer" + "{ left: inherit; right: 20px; }"),
                                E.addCSSRule(n + i.id + "-right-" + t + " .mainMediaContainer .overviewContainer" + "{ left: 20px; }"),
                                E.addCSSRule(n + i.id + "-right-" + t + " .mainMediaContainer .legendContainer" + "{ right:" + r + "; }");
                        });
                });
            }
            function I(e) {
                E.addCSSRule(".mobilePopup { max-height:" + Math.min(e.height - 120, 300) + "px; }", "MobilePopup");
            }
            function q(e) {
                var t = i.getLayoutId(),
                    n = i.getLayoutOptions(),
                ...
                if (e < 0 || e > app.data.getStoryLength() - 1) return;
                var s = app.data.getStoryByIndex(e);
                if (app.data.getCurrentSection()) {
                    var o = app.data.getCurrentSection(),
                        u = o && o.media ? o.media.type : null,
                        a = s && s.media ? s.media.type : null;
                    u != a && (r = !0);
                }
                M() && (!s || s.media.type != "webmap" || !s.media.webmap.popup) && h.close($(".mainMediaContainer.active .mapContainer").siblings(".mobileInfoWindow")), app.data.setCurrentSectionIndex(e);
                var f = R(),
                    l = t == "accordion" || f.description || (f.legend && n.legend == "panel");
                $("body")
                    .toggleClass("layout-" + t + "-" + n.panel.position, l)
                    .toggleClass("layout-" + t + "-" + n.panel.position + "-" + n.panel.sizeLbl, l),
                    t == "accordion" ? app.ui.accordionPanel.showEntryIndex(e) : (app.ui.navBar.showEntryIndex(e), app.ui.descLegendPanel.showEntryIndex(e, !1, f), j()),
                    M() && (app.ui.mobileHeader.showEntryIndex(e), app.ui.mobileEntryInfo.showEntryIndex(e, f), app.ui.mobileFooter.showEntryIndex(e)),
                    app.ui.mainStage.updateMainMediaWithStoryMainMedia(e, r),
                    $(".mediaBackContainer").hide();
            }
            function R() {
                var e = app.data.getCurrentSection(),
                    t = i.getLayoutId(),
                    n = i.getLayoutOptions();
                return !e || !e.media || !e.media[e.media.type]
                    ? {}
                    : { description: !((t != "accordion" && !n.description) || (!e.description && !app.isInBuilder)), legend: e.media.type == "webmap" && !!e.media.webmap.legend && !!e.media.webmap.legend.enable };
            }
            function U(e) {
                var t = R(),
                    n = app.data.getCurrentEntryIndex(),
                    r = !1,
                    i = -1;
                if (!e || !e.from || !e.direction) return;
                e.from == "nav"
                    ? (app.isInBuilder && (r = !0), n === 0 && e.direction == "backward" ? (r = !0) : t.description && e.direction == "forward" ? app.ui.descLegendPanel.focus() : (r = !0))
                    : e.from == "panel" && e.direction == "forward"
                        ? (r = !0)
                        : e.from == "panel" && e.direction == "backward" && x.publish("story-navigate-entry", n);
                if (r) {
                    if (e.direction == "forward") {
                        if (!(n < app.data.getStoryLength() - 1)) return window != window.top ? parent.document.focus() : app.ui.headerDesktop.focus({ area: "social" }), !1;
                        i = n + 1;
                    } else if (e.direction == "backward") {
                        if (!(n > 0)) return app.ui.headerDesktop.focus({ area: "title" }), !1;
                        i = n - 1;
                    }
                    x.publish("story-navigate-entry", i);
                }
            }
            function z() {
                var e = app.data.getCurrentSection(),
                ...
                if (!t) return;
                n ? x.publish("CORE_UPDATE_EXTENT", new N(e.media.webmap.extent)) : x.publish("CORE_UPDATE_EXTENT", app.maps[r].response.map._params.extent);
            }
            var b = null;
            (this.init = function (e) {
                return (
                    (b = e),
                    app.isInBuilder && S("ie") && S("ie") < 10
                        ? ((i18n.viewer.errors.noBuilderIE = i18n.viewer.errors.noBuilderIE.replace("%VERSION%", 10).replace("%UPGRADE%", i18n.viewer.errors.upgradeBrowser)), b.initError("noBuilderIE"), !1)
                        : S("ie") && S("ie") <= 8
                            ? ((i18n.viewer.errors.noViewerIE = i18n.viewer.errors.noViewerIE.replace("%VERSION%", 9).replace("%UPGRADE%", i18n.viewer.errors.upgradeBrowser)), b.initError("noViewerIE"), !1)
                            : ($(document).bind("touchmove", function (e) {
                                $(e.target).parents(".legendContainer, #descLegendPanel, #accordionPanel, .mobilePopup, #headerMobile, .settings-layout").length || e.preventDefault();
                            }),
                                (app.data = new r()),
                                (app.ui.mainStage = new t($("#mainStagePanel"), app.isInBuilder, this)),
                                (app.ui.accordionPanel = new o($("#accordionPanel"), app.isInBuilder, q)),
                                (app.ui.navBar = new u($("#nav-bar"), app.isInBuilder, q)),
                                (app.ui.descLegendPanel = new a($("#descLegendPanel"), app.isInBuilder)),
                                F(),
                                (app.ui.mobileHeader = new f($("#headerMobile"), app.isInBuilder, q)),
                                (app.ui.mobileEntryInfo = new l($("#mobileInfoBtn"))),
                                (app.ui.mobileFooter = new c($("#footerMobile"), app.isInBuilder, q)),
                                !app.isInBuilder &&
                                E.getUrlParams().autoplay !== undefined &&
                                E.getUrlParams().autoplay !== "false" &&
                                ((app.ui.autoplay = new g($("#autoplay"), function () {
                                    var e = 0;
                                    return (
                                        app.data.getCurrentEntryIndex() != app.data.getStoryLength() - 1 && (e = app.data.getCurrentEntryIndex() + 1),
                                        setTimeout(function () {
                                            x.publish("story-navigate-entry", e);
                                        }, 50),
                                        e
                                    );
                                })),
                                    x.subscribe("tpl-ready", function () {
                                        $("body").hasClass("mobile-view") || app.ui.autoplay.start();
                                    }),
                                    x.subscribe("story-load-entry", function (e) {
                                        app.ui.autoplay.onNavigationEvent(e);
                                    })),
                                x.subscribe("story-navigate-entry", q),
                                x.subscribe("story-update-entries", D),
                                x.subscribe("story-update-entry", P),
                                x.subscribe("story-entry-reset-map-extent", z),
                                x.subscribe("ADDEDIT_LOAD_WEBMAP", app.ui.mainStage.loadTmpWebmap),
                                x.subscribe("ADDEDIT_SHOW_WEBMAP", app.ui.mainStage.showWebmapById),
                                x.subscribe("ADDEDIT_RELOAD_CURRENT_WEBMAP", app.ui.mainStage.reloadCurrentWebmap),
                                x.subscribe("story-loaded-map", function (e) {
                                    e.index == app.data.getCurrentSectionIndex() && j();
                                }),
                                $("body").on("mousedown", "*", function (e) {
                                    ($(this).is(":focus") || $(this).is(e.target)) &&
                                        ...
                                        ($(this)
                                            ...
                                            $(this).parents(".image-container").length &&
                                            $(this)
                                            ...
                                            $(this).parents("figure.caption").length &&
                                            $(this)
                                                .parents("figure.caption")
                                                .css("outline", "none")
                                                .on("blur", function () {
                                                    $(this).off("blur").css("outline", "");
                                                }),
                                            $(this).parents("p").length &&
                                            $(this)
                                                .parents("p")
                                                .css("outline", "none")
                                                .on("blur", function () {
                                            ...
                                            $(this).parents(".accordion-header-content").length &&
                                            $(this)
                                                .parents(".accordion-header-content")
                                                .css("outline", "none")
                                                .on("blur", function () {
                                                    $(this).off("blur").css("outline", "");
                                                }));
                                }),
                                x.subscribe("story-tab-navigation", U),
                                !0)
                );
            }),
                ...
                (this.loadWebmap = function (e, t, n) {
                    ...
                    var r = null;
                    return T.createMap(e, t, {
                        mapOptions: { slider: !0, autoResize: !1, showAttribution: !0, infoWindow: r, extent: n },
                        usePopupManager: !0,
                        ignorePopups: !1,
                ...
                (this.getMapConfig = function (e, t) {
                    return {
                        response: e,
                        mapCommand: new p(e.map, z, b.zoomToDeviceLocation, app.data.getWebAppData().getLocateBtn()),
                        legend: new d(e, app.isInBuilder, k(t, e.itemInfo.item.id)),
                        overview: new v(e.map, t.siblings(".overview"), app.isInBuilder),
                        geocoder: new m(e.map, app.isInBuilder, app.data.getWebAppData().getGeocoder(), w(e)),
                    };
                }),
                (this.updateUI = function () {
                    ...
                    if ($("body").hasClass("switchLayout")) {
                        var n = $.map($("body").attr("class").split(" "), function (e) {
                            return e.match(/layout-/) ? e : null;
                        }).join(" ");
                        $("body").removeClass("switchLayout").removeClass(n),
                            O(t),
                            setTimeout(function () {
                                q(app.data.getCurrentSectionIndex()), D();
                            }, 50);
                    }
                    $("body")
                        .addClass("layout-" + t)
                        .attr("data-theme-major", e.themeMajor),
                        $.each(Object.keys(app.maps), function (e, t) {
                            app.maps[t].mapCommand.enableLocationButton(i.getLocateBtn()), app.maps[t].geocoder.toggle(i.getGeocoder()), app.maps[t].legend.updatePlacementSettings(k($(app.maps[t].response.map.container), t));
                        }),
                        B(),
                        H(),
                ...
                (this.resize = function (e) {
                    ...
                    $("#mainStagePanelInner, #accordionPanel > .content").height($("#contentPanel").height()),
                        t == "accordion" ? app.ui.accordionPanel.resize(e) : (app.ui.navBar.resize(e), app.ui.descLegendPanel.resize(e)),
                        M() && app.ui.mobileFooter.resize(e);
                    var n = app.data.getCurrentSectionIndex();
                    app.ui.mobileFooter.showEntryIndex(n), C.styleSectionPanelContent(), app.ui.mainStage.updateMainStageWithLayoutSettings();
                    var r = window.location != window.parent.location ? !0 : !1;
                    !S("ios") && !r && I(e), e.isMobileView && app.ui.autoplay && app.ui.autoplay.stop();
                }),
                (this.setMapExtent = function (e, t) {
                    return b.setMapExtent(e, t);
                }),
                (this.getLayoutExtent = function (e, t, n) {
                    return s.getLayoutExtent(e, t, n);
                }),
                (this.checkConfigFileIsOK = function () {
                    return n.checkConfigFileIsOK();
                }),
                (this.appInitComplete = function () {
                    this.updateUI(), b.cleanLoadingTimeout(), $(window).resize();
                    var e = app.data.getWebAppData().isBlank() || app.data.getWebAppItem().access == "private" || app.data.getWebAppItem().access == "shared";
                    app.ui.headerDesktop && app.ui.headerDesktop.toggleSocialBtnAppSharing(e),
                        app.ui.autoplay && (app.ui.headerDesktop && app.ui.headerDesktop.enableAutoplay(), app.ui.mobileHeader && app.ui.mobileHeader.enableAutoplay()),
                        app.isDirectCreation || b.displayApp(),
                        x.publish("tpl-ready"),
                        app.ui.mainStage.preloadAllMaps();
                    var t = window.location != window.parent.location ? !0 : !1;
                    S("ios") && t && I({ height: $(window).height });
                }),
    ...
    require(["storymaps/common/Core", "storymaps/common/ui/header/Desktop", "storymaps/tpl/core/MainView"], function () { }),
